...
const q={schema:'lane-watch-work-queue/v1',title:'Queue',updatedAt:'2026-09-05T00:00:00Z',cutoffAt:'2026-09-05T13:00:00Z',cadenceMinutes:50,items:[{id:'a',title:'Existing result',status:'ready',kind:'campaign',detail:'No launch',dependsOn:[]}]};
