...
function As(e) {
	...
	let t = Array.isArray(e?.receipt?.effects?.changedPaths) ? e.receipt.effects.changedPaths : [], n = ks(e), r = Number(e?.tokenCap || Os(e?.effortClass === "medium" ? "medium" : "small"));
...
function Ns(e) {
	return /asymmetric-laboratory intake replay/i.test(e?.task || "") ? [js(e, "Verify frozen asymmetric manifest, provenance, and control count", "Separate source binding and the eleven-type inventory audit from computational replay so a mismatch can stop cheaply.", "small", [
	...
	], "results/inbox/strategy-cost-source-binding-v1/**", "One source-binding pass only. Record UNKNOWN with provenance when a measurement cannot be recovered; do not estimate or rerun research."), js(e, "Reconcile epoch reservation and wall-time scopes", "Apply the source-bound measurement inventory to the 148,741-versus-80,000 reservation and process-versus-observer timing discrepancy.", "small", [
...
Ho();
var Ps = /* @__PURE__ */ G("<div class=\"rail-direction\"><span>CURRENT GROUNDING</span><strong> </strong></div>"), Fs = /* @__PURE__ */ G("<div class=\"rail-observation\"><span>OBSERVED ACTIVITY · NON-AUTHORITATIVE</span><strong> </strong></div>"), Is = /* @__PURE__ */ G("<button> </button>"), Ls = /* @__PURE__ */ G("<li><b> </b><span> </span></li>"), Rs = /* @__PURE__ */ G("<ul></ul>"), zs = /* @__PURE__ */ G("<p> </p> <!>", 1), Bs = /* @__PURE__ */ G("<li><b> </b><div><strong> </strong><p> </p><small> </small></div></li>"), Vs = /* @__PURE__ */ G("<ol></ol>"), Hs = /* @__PURE__ */ G("<details class=\"rail-inspector\"><summary><span>Inspect the decision packet</span><strong> </strong></summary> <div class=\"rail-packet\"><!> <label class=\"rail-note\"><span>Operator note or revision direction</span><textarea rows=\"3\" placeholder=\"Optional, but useful when redirecting or requesting revision\"></textarea></label></div></details>"), Us = /* @__PURE__ */ G("<div class=\"recovery-report\"><div class=\"recovery-report-grid\"><div><span>WORKFLOW</span><strong> </strong></div> <div><span>FROZEN WAVE</span><strong> </strong></div> <div><span>ACCOUNTING</span><strong> </strong></div> <div><span>CONTROLLED EXECUTION</span><strong> </strong></div></div> <p class=\"recovery-digest\"><span>BOUND REPORT</span><code> </code></p> <p> </p> <label class=\"recovery-choice\"><span>Explicit recovery decision</span><select><option>Preserve the current hold</option><option>Align the historical wave to the workflow</option><option>Align the workflow to the frozen wave</option><option>Apply terminal-evidence projection repair</option></select></label> <label class=\"rail-note\"><span>Recovery rationale</span><textarea rows=\"3\" placeholder=\"Why this historical boundary—not the research direction—should change\"></textarea></label> <label class=\"recovery-confirm\"><input type=\"checkbox\"/><span>I reviewed the exact digest and authorize only this historical recovery decision.</span></label> <div class=\"recovery-boundary\"><strong>No inferred authority</strong><span>This command cannot infer a worker result, dispatch work, promote claims, merge, or push.</span></div> <button class=\"primary-button recovery-apply\"> </button></div>"), Ws = /* @__PURE__ */ G("<div class=\"recovery-report empty\"><p>Freeze a fresh report before choosing a transition. Preparation is read-only with respect to campaign workflow, workers, claims, Git, and publication.</p></div>"), Gs = /* @__PURE__ */ G("<details class=\"rail-inspector rail-recovery\"><summary><span>Historical recovery protocol</span><strong> </strong></summary> <!></details>"), Ks = /* @__PURE__ */ G("<div role=\"status\"> </div>"), qs = /* @__PURE__ */ G("<section class=\"lifecycle-focus primary-action-rail\" id=\"next-action\" aria-live=\"polite\"><div class=\"rail-copy\"><div class=\"rail-kicker\"><span> </span><strong> </strong><i> </i></div> <h2> </h2> <p> </p> <!> <!> <details class=\"rail-hint\"><summary><span>WHY THIS MATTERS</span><strong>Plain-language hint + mathematical connection</strong></summary> <div><p><b>What this state means.</b> </p> <p><b>Mathematical connection.</b> </p> <p><b>What your click changes.</b> </p></div></details></div> <div class=\"lifecycle-actions rail-actions\"></div> <!> <!> <!></section>"), Js = /* @__PURE__ */ G("<button><strong> </strong><span> </span><small> </small></button>"), Ys = /* @__PURE__ */ G("<section class=\"project-picker\" aria-label=\"Campaign projects\"><div><p class=\"eyebrow\">CAMPAIGNS</p><h2>Choose a campaign control surface</h2></div> <div></div></section>");
function Xs(e, t) {
	bt(t, !1);
	...
	var ee = ca(), M = R(ee), te = (e) => {
		var t = qs(), n = L(t), r = L(n), i = L(r), a = L(i, !0);
		N(i);
		var o = z(i), y = L(o, !0);
		N(o);
		var b = z(o), C = L(b, !0);
		...
		J(M, (e) => {
			H(d), U(() => H(d).controlState?.observation) && e(te);
		});
		var ne = z(M, 2), re = z(L(ne), 2), ie = L(re), ae = z(L(ie));
		N(ie);
		...
		var me = z(de, 2), he = (e) => {
			var t = Gs(), n = L(t), r = z(L(n)), i = L(r, !0);
			N(r), N(n);
			var a = z(n, 2), o = (e) => {
...
function ac(e) {
	let t = rc(e?.researchRuns).filter((e) => [
		"launching",
		"running",
		"blocked",
		"evidence_ready",
...
function sc(e) {
	let t = e?.wave?.synthesis?.response || null, n = e?.researchPlan?.response || null, r = t?.operatorBrief || {}, i = e?.strategy?.charter || {}, a = !!(n && [
		...
		"RESEARCH_READY",
		"REVISING"
	].includes($(e?.phase))), o = a ? "checked-plan" : t ? "frozen-synthesis" : n ? "checked-plan" : "campaign-state", s = ac(e), c = {
		...
		evidence: rc(r.recentProgress).map((e) => $(e)).filter(Boolean),
		scope: rc(r.watchouts).map((e) => $(e)).filter(Boolean)
	}, u = (a && rc(n?.lanes).length ? rc(n.lanes).filter((e) => $(e?.action).toUpperCase() !== "DROP") : rc(t?.nextWave?.lanes).length ? rc(t.nextWave.lanes) : rc(n?.lanes)).filter(Boolean), d = new Set(a ? u.map((e) => $(e?.strategy?.trackId, $(e?.trackId))).filter(Boolean) : [s].filter(Boolean)), f = {
		id: "next-decision",
		kind: "decision",
		...
		trackId: $(e?.id),
		relation: `This track is one of ${Math.max(1, rc(i.tracks).length)} balanced routes to the campaign objective.`,
		metrics: rc(e?.metrics).map((e) => $(e)).filter(Boolean),
		color: $(e?.color, "#71d6a0")
	})), m = rc(t?.claimDeltas).map((e, t) => ({
		...
		evidence: rc(e?.evidence).map((e) => $(e)).filter(Boolean),
		scope: rc(e?.objections).map((e) => $(e)).filter(Boolean)
	})), h = u.map((e, t) => {
		let r = rc(n?.lanes).find((t) => t?.taskId === e?.taskId) || e, i = $(r?.strategy?.trackId, $(e?.trackId, "unassigned"));
		return {
		...
		claims: m,
		proposals: h
	}), _ = nc.filter((e) => e.pattern.test(g)).map((e) => ({
		id: `concept-${e.id}`,
		kind: "concept",
		kicker: "OBJECT CODEX",
		title: e.title,
	...
	return {
		...
		quest: l,
		decision: f,
		progress: rc(r.recentProgress).map((e) => $(e)).filter(Boolean),
		watchouts: rc(r.watchouts).map((e) => $(e)).filter(Boolean),
		tracks: p,
		claims: m,
		proposals: h,
		concepts: _
...
Ho();
var lc = /* @__PURE__ */ G("<li><b></b><span> </span></li>"), uc = /* @__PURE__ */ G("<ol></ol>"), dc = /* @__PURE__ */ G("<p>No synthesized progress delta is available yet.</p>"), fc = /* @__PURE__ */ G("<li> </li>"), pc = /* @__PURE__ */ G("<div class=\"brief-ledger\"><section><header><span>WHAT CHANGED</span><strong> </strong></header> <!></section> <details open=\"\"><summary><span>SCOPE & WATCHOUTS</span><strong> </strong></summary> <ul></ul></details></div>"), mc = /* @__PURE__ */ G("<button><span> </span><strong> </strong><small> </small></button>"), hc = /* @__PURE__ */ G("<div class=\"atlas-empty\"><span>OPEN CAPACITY</span><strong>No current claim or proposed lane is assigned here.</strong></div>"), gc = /* @__PURE__ */ G("<section class=\"atlas-track\"><button><span> </span><strong> </strong><small> </small></button> <div><!></div></section>"), _c = /* @__PURE__ */ G("<button><span>CONTEXT</span><strong> </strong></button>"), vc = /* @__PURE__ */ G("<section class=\"object-codex\"><header><span>OBJECT CODEX</span><strong>Learn the mathematical pieces on this map</strong></header> <div></div></section>"), yc = /* @__PURE__ */ G("<details open=\"\"><summary>Evidence <strong> </strong></summary><ul></ul></details>"), bc = /* @__PURE__ */ G("<details open=\"\"><summary>Scope & objections <strong> </strong></summary><ul></ul></details>"), xc = /* @__PURE__ */ G("<details><summary>What this could unlock <strong> </strong></summary><ul></ul></details>"), Sc = /* @__PURE__ */ G("<details><summary>Progress measures <strong> </strong></summary><ul></ul></details>"), Cc = /* @__PURE__ */ G("<div class=\"atlas-inspector-lists\"><!> <!> <!> <!></div>"), wc = /* @__PURE__ */ G("<aside aria-live=\"polite\"><header><div><span> </span><h4> </h4></div><strong> </strong></header> <div class=\"atlas-inspector-grid\"><section><span>WHAT THIS IS</span><p> </p></section> <section><span>WHY IT MATTERS</span><p> </p></section> <section><span>HOW IT CONNECTS</span><p> </p></section> <section><span>AUTHORITY</span><p> </p></section></div> <!></aside>"), Tc = /* @__PURE__ */ G("<section class=\"interpretation-surface\" id=\"campaign-interpretation\" aria-label=\"Campaign interpretation and research atlas\"><header class=\"interpretation-heading\"><div><p>CAMPAIGN INTERPRETATION</p> <h2>Understand the mission before choosing the move</h2> <span>A generated briefing and explorable mathematical map, grounded in the same frozen evidence as the control plane.</span></div> <strong> </strong></header> <div class=\"director-deck\"><button><span> </span> <strong> </strong> <p> </p> <small> </small></button> <i class=\"director-link\" aria-hidden=\"true\"></i> <button><span> </span> <strong> </strong> <p> </p> <small> </small></button> <i class=\"director-link\" aria-hidden=\"true\"></i> <button><span> </span> <strong> </strong> <p> </p> <small> </small></button></div> <!> <section class=\"research-atlas\" aria-label=\"Research Atlas\"><header><div><p>RESEARCH ATLAS</p><h3>How bounded work connects back to the campaign objective</h3><span>Select any station to inspect its meaning, evidence, scope, and unlocks.</span></div> <div class=\"atlas-legend\" aria-label=\"Interpretation status legend\"><span class=\"supported\">SUPPORTED</span><span class=\"proposed\">PROPOSED</span><span class=\"unmeasured\">UNMEASURED</span><span class=\"blocked\">BLOCKED</span><span class=\"context\">CONTEXT</span></div></header> <div class=\"atlas-board\"><div class=\"atlas-north-star\"><button><span>NORTH STAR</span><strong> </strong></button> <i aria-hidden=\"true\"></i> <button><span>CURRENT KNOWLEDGE</span><strong> </strong></button> <i aria-hidden=\"true\"></i> <button><span>NEXT BRANCH</span><strong> </strong></button></div> <div class=\"atlas-track-list\"></div> <!></div> <!> <footer><b>INTERPRETATION IS NOT AUTHORITY</b><span>Generated prose helps navigate. Exact receipts, claim states, and human gates remain the source of campaign authority.</span></footer></section></section>");
function Ec(e, t) {
	bt(t, !1);
	...
	var p = ca(), m = R(p), h = (e) => {
		...
		N(ne), N(O), N(o);
		var ie = z(o, 2), ae = (e) => {
			var t = pc(), n = L(t), r = L(n), i = z(L(r)), a = L(i);
			N(i), N(r);
			var o = z(r, 2), c = (e) => {
				var t = uc();
		...
		var we = z(se, 2), Te = (e) => {
			var t = wc(), n = L(t), r = L(n), i = L(r), o = L(i);
			N(i);
			var s = z(i), c = L(s, !0);
			N(s), N(r);
			var l = z(r), u = L(l, !0);
...
Zi(["click"]), Ho();
var Dc = /* @__PURE__ */ G("<a target=\"_blank\" rel=\"noreferrer\">Open source ↗</a>"), Oc = /* @__PURE__ */ G("<p class=\"redirect-error\"> </p>"), kc = /* @__PURE__ */ G("<div class=\"redirect-shift\"><span>Proposed shift</span><strong> </strong></div>"), Ac = /* @__PURE__ */ G("<div><span> </span><strong> </strong><p> </p></div>"), jc = /* @__PURE__ */ G("<details><summary> </summary><div class=\"redirect-direction-list\"></div></details>"), Mc = /* @__PURE__ */ G("<div class=\"redirect-gate\"><small>Applying changes future synthesis and planning context and stages any new questions as proposals. It does not launch a worker.</small><button class=\"primary-button\"> </button></div>"), Nc = /* @__PURE__ */ G("<article class=\"redirect-proposal\"><div class=\"redirect-proposal-heading\"><div><span> </span><strong> </strong></div><!></div> <!> <p> </p> <!> <!> <!></article>"), Pc = /* @__PURE__ */ G("<div><span> </span><strong> </strong><small> </small></div>"), Fc = /* @__PURE__ */ G("<details class=\"redirect-history\"><summary>Earlier external inputs <strong> </strong></summary><!></details>"), Ic = /* @__PURE__ */ G("<div role=\"status\"> </div>"), Lc = /* @__PURE__ */ G("<section id=\"external-perspective\"><div class=\"redirect-heading\"><div><p class=\"eyebrow\">EXTERNAL PERSPECTIVE</p><h3>Widen or redirect the campaign</h3><p>Drop in a paper, argument, observation, or reframing. It pauses autopilot at a safe boundary and asks Sol to reshape direction without dispatching or invalidating landed evidence.</p></div><span class=\"redirect-status\"> </span></div> <details class=\"redirect-composer\"><summary><span> </span><strong>Sol read-only pass</strong></summary> <div class=\"redirect-fields\"><input maxlength=\"240\" placeholder=\"Short title (optional)\"/><input maxlength=\"2000\" inputmode=\"url\" placeholder=\"Source link (optional)\"/></div> <textarea id=\"redirect-content\" rows=\"6\" maxlength=\"24000\" placeholder=\"Paste the relevant idea, critique, external result, or your own reframing…\"></textarea> <div class=\"redirect-submit\"><small>This becomes an immutable input bundle. Sol compares it with the current synthesis, checked plan, and run history.</small><button class=\"primary-button\"> </button></div></details> <!> <!> <!></section>");
function Rc(e, t) {
	bt(t, !1);
	...
	var E = ca(), D = R(E), O = (e) => {
		var t = Lc(), n = L(t), r = z(L(n)), i = L(r, !0);
		N(r), N(n);
		...
		N(j), N(A), N(d);
		var M = z(d, 2), te = (e) => {
			var t = Nc(), n = L(t), r = L(n), i = L(r), a = L(i);
			N(i);
			var l = z(i), u = L(l, !0);
			N(l), N(r);
			var d = z(r), f = (e) => {
		...
		var ne = z(M, 2), re = (e) => {
			var t = Fc(), n = L(t), r = z(L(n)), i = L(r, !0);
...
Zi(["input", "click"]), Ho();
var zc = /* @__PURE__ */ G("<div><button class=\"outline-button compact\">Decline</button><button class=\"danger-button\">Accept</button></div>"), Bc = /* @__PURE__ */ G("<article><div><strong> </strong><p> </p></div><!></article>"), Vc = /* @__PURE__ */ G("<section class=\"coordinator-approvals\"><h3>Tool approval requests</h3><!></section>"), Hc = /* @__PURE__ */ G("<p>Syncing coordinator history…</p>"), Uc = /* @__PURE__ */ G("<article><span> </span><p> </p></article>"), Wc = /* @__PURE__ */ G("<p>No coordinator messages are loaded yet.</p>"), Gc = /* @__PURE__ */ G("<button class=\"danger-button\">Interrupt turn</button>"), Kc = /* @__PURE__ */ G("<div class=\"coordinator-boundary\"><strong>Semantic coordinator</strong><p>Plans, synthesizes, and checks direction. Dispatch, claim promotion, merges, pushes, and tool approvals remain separate gates.</p></div> <!> <div class=\"coordinator-transcript\" aria-live=\"polite\"><!></div> <div class=\"coordinator-composer\"><textarea rows=\"3\" maxlength=\"12000\" placeholder=\"Message Sol…\"></textarea><div><small>Messages may steer an active turn; they do not bypass campaign gates.</small><button class=\"primary-button\"> </button></div></div> <div class=\"coordinator-utility\"><button class=\"outline-button compact\">Sync history</button><!></div>", 1), qc = /* @__PURE__ */ G("<button><strong> </strong><span> </span></button>"), Jc = /* @__PURE__ */ G("<p>No attachable workspace tasks found.</p>"), Yc = /* @__PURE__ */ G("<div class=\"coordinator-candidates\"><!><!></div>"), Xc = /* @__PURE__ */ G("<div class=\"coordinator-boundary\"><strong>Attach an existing Codex task</strong><p>Lane Watch will verify workspace eligibility before attaching it as the campaign’s semantic coordinator.</p></div> <button class=\"primary-button\"> </button> <!>", 1), Zc = /* @__PURE__ */ G("<div class=\"gate-feedback\" role=\"status\"> </div>"), Qc = /* @__PURE__ */ G("<details class=\"coordinator-console\" id=\"coordinator-console\"><summary><span><small>SOL COORDINATOR</small><strong> </strong></span><span> </span></summary> <div class=\"coordinator-console-body\"><!> <!></div></details>");
function $c(e, t) {
	bt(t, !1);
	...
	var b = ca(), x = R(b), S = (e) => {
		var t = Qc(), n = L(t), r = L(n), i = z(L(r)), c = L(i, !0);
		N(i), N(r);
		var f = z(r), p = L(f);
		N(f), N(n);
		var b = z(n, 2), x = L(b), S = (e) => {
			var t = Kc(), n = z(R(t), 2), r = (e) => {
				var t = Vc();
...
Zi(["click"]), Ho();
var el = /* @__PURE__ */ G("<div class=\"campaign-settings-boundary access-boundary\"><strong> </strong><p> </p></div>"), tl = /* @__PURE__ */ G("<div class=\"campaign-settings-boundary\"><strong> </strong><p> </p><small>Observation never grants authority. Human wave adoption imports a fixed wave; exact human schedule confirmation grants controller execution only to reserved members.</small></div>"), nl = /* @__PURE__ */ G("<button type=\"button\"><span> </span><strong> </strong><small> </small><p> </p></button>"), rl = /* @__PURE__ */ G("<p> </p>"), il = /* @__PURE__ */ G("<article><span> </span><strong> </strong><small> </small><small> </small></article>"), al = /* @__PURE__ */ G("<span><small> </small><strong> </strong></span>"), ol = /* @__PURE__ */ G("<div class=\"host-capability-grid\"></div> <div class=\"global-quota-grid\"><span><small>TOKEN COMMITMENTS</small><strong> </strong></span> <!></div> <footer>ENFORCED AT SERIALIZED RESOURCE ACQUISITION · no scheduler or host mutation authority</footer>", 1), sl = /* @__PURE__ */ G("<div class=\"gate-feedback\" role=\"status\"> </div>"), cl = /* @__PURE__ */ G("<details class=\"campaign-settings\" id=\"campaign-settings\"><summary><span><small>FUTURE-RUN POLICY</small><strong> </strong></span><span> </span></summary> <div class=\"campaign-settings-body\"><div class=\"campaign-settings-boundary\"><strong>Defaults, never active mutations</strong><p>These choices apply only when a later checked contract is confirmed. They do not restaff a running lane, approve a plan, or launch anything.</p></div> <!> <!> <div class=\"dispatch-profile-grid\"></div> <label class=\"automation-setting\"><span><strong>Automatic boundary handling</strong><small>Controls how far the controller may prepare between explicit human gates.</small></span><select><option>observe</option><option>prepare</option><option>propose</option><option>bounded</option></select></label> <section class=\"operational-governance\" aria-label=\"Operational governance\"><header><span><small>HOSTS & GLOBAL QUOTAS</small><strong>Pre-admission inventory</strong></span><b> </b></header> <!></section> <!></div></details>");
function ll(e, t) {
	bt(t, !1);
	...
	var g = ca(), _ = R(g), v = (e) => {
		var t = cl(), r = L(t), i = L(r), d = z(L(i)), g = L(d, !0);
		N(d), N(i);
		var _ = z(i), v = L(_);
		N(_), N(r);
		var y = z(r, 2), b = z(L(y), 2), x = (e) => {
			var t = el(), r = L(t), i = L(r);
			N(r);
			var a = z(r), o = L(a);
			N(a), N(t), V((e) => {
...
Zi(["click", "change"]), Ho();
var ul = /* @__PURE__ */ G("<p><b> </b> </p>"), dl = /* @__PURE__ */ G("<div class=\"accounting-controls\"><select><option>Choose disposition</option><option>Repair</option><option>Supersede</option><option>Abandon</option><option>Carry forward</option></select><input placeholder=\"Reason and evidence boundary\"/><button class=\"primary-button\"> </button></div>"), fl = /* @__PURE__ */ G("<li><span class=\"accounting-state\"> </span> <div><strong> </strong><small> </small><!></div> <!></li>"), pl = /* @__PURE__ */ G("<div class=\"gate-feedback\" role=\"status\"> </div>"), ml = /* @__PURE__ */ G("<details class=\"wave-accounting\" id=\"wave-accounting\"><summary><span><small>WAVE CUSTODY</small><strong>Source-lane accounting</strong></span><span> </span></summary> <div class=\"wave-accounting-body\"><div class=\"accounting-boundary\"><strong>Mechanical disposition only</strong><p>Recording a repair, supersession, abandonment, or carry-forward closes custody accounting. It does not endorse the lane’s mathematics or promote a claim.</p></div> <ol></ol> <!></div></details>");
function hl(e, t) {
	bt(t, !1);
...
vl.prototype = _l.prototype = {
	constructor: vl,
	on: function(e, t) {
		var n = this._, r = yl(e + "", n), i, a = -1, o = r.length;
		if (arguments.length < 2) {
			for (; ++a < o;) if ((i = (e = r[a]).type) && (i = bl(n[i], e.name))) return i;
			return;
		}
		if (t != null && typeof t != "function") throw Error("invalid callback: " + t);
		for (; ++a < o;) if (i = (e = r[a]).type) n[i] = xl(n[i], e.name, t);
...
function xl(e, t, n) {
	for (var r = 0, i = e.length; r < i; ++r) if (e[r].name === t) {
		e[r] = gl, e = e.slice(0, r).concat(e.slice(r + 1));
		break;
	}
...
function Cl(e) {
	var t = e += "", n = t.indexOf(":");
	return n >= 0 && (t = e.slice(0, n)) !== "xmlns" && (e = e.slice(n + 1)), Sl.hasOwnProperty(t) ? {
		space: Sl[t],
		local: e
	} : e;
}
...
function Nl(e) {
	return function() {
		return Al(e.apply(this, arguments));
	};
}
function Pl(e) {
	e = typeof e == "function" ? Nl(e) : Ml(e);
...
function Bl(e) {
	return this.select(e == null ? zl : Rl(typeof e == "function" ? e : Il(e)));
}
//#endregion
...
function Ul(e) {
	return function() {
		return Vl.call(this.children, e);
	};
}
function Wl(e) {
	return this.selectAll(e == null ? Hl : Ul(typeof e == "function" ? e : Il(e)));
}
//#endregion
...
function ql() {
	return new _d(this._enter || this._groups.map(Kl), this._parents);
}
function Jl(e, t) {
...
function Xl(e, t, n, r, i, a) {
	for (var o = 0, s, c = t.length, l = a.length; o < l; ++o) (s = t[o]) ? (s.__data__ = a[o], r[o] = s) : n[o] = new Jl(e, a[o]);
	for (; o < c; ++o) (s = t[o]) && (i[o] = s);
}
function Zl(e, t, n, r, i, a, o) {
	var s, c, l = /* @__PURE__ */ new Map(), u = t.length, d = a.length, f = Array(u), p;
	for (s = 0; s < u; ++s) (c = t[s]) && (f[s] = p = o.call(c, c.__data__, s, t) + "", l.has(p) ? i[s] = c : l.set(p, c));
	for (s = 0; s < d; ++s) p = o.call(e, a[s], s, a) + "", (c = l.get(p)) ? (r[s] = c, c.__data__ = a[s], l.delete(p)) : n[s] = new Jl(e, a[s]);
...
function $l(e, t) {
	...
	var n = t ? Zl : Xl, r = this._parents, i = this._groups;
	typeof e != "function" && (e = Yl(e));
	for (var a = i.length, o = Array(a), s = Array(a), c = Array(a), l = 0; l < a; ++l) {
		var u = r[l], d = i[l], f = d.length, p = eu(e.call(u, u && u.__data__, l, r)), m = p.length, h = s[l] = Array(m), g = o[l] = Array(m);
	...
	return o = new _d(o, r), o._enter = s, o._exit = c, o;
}
function eu(e) {
...
function tu() {
	return new _d(this._exit || this._groups.map(Kl), this._parents);
}
//#endregion
...
function au(e) {
	...
	return new _d(i, this._parents).order();
}
function ou(e, t) {
...
function yu(e, t) {
	...
	return this.each((t == null ? n.local ? mu : pu : typeof t == "function" ? n.local ? vu : _u : n.local ? gu : hu)(n, t));
}
//#endregion
...
function wu(e, t, n) {
	return arguments.length > 1 ? this.each((t == null ? xu : typeof t == "function" ? Cu : Su)(e, t, n ?? "")) : Tu(this.node(), e);
}
function Tu(e, t) {
...
function ku(e, t) {
	return arguments.length > 1 ? this.each((t == null ? Eu : typeof t == "function" ? Ou : Du)(e, t)) : this.node()[e];
}
//#endregion
...
function Nu(e, t) {
	for (var n = ju(e), r = -1, i = t.length; ++r < i;) n.add(t[r]);
}
function Pu(e, t) {
	for (var n = ju(e), r = -1, i = t.length; ++r < i;) n.remove(t[r]);
}
function Fu(e) {
	return function() {
		Nu(this, e);
...
function Lu(e, t) {
	return function() {
		(t.apply(this, arguments) ? Nu : Pu)(this, e);
	};
}
function Ru(e, t) {
	var n = Au(e + "");
	if (arguments.length < 2) {
		for (var r = ju(this.node()), i = -1, a = n.length; ++i < a;) if (!r.contains(n[i])) return !1;
		return !0;
	}
	return this.each((typeof t == "function" ? Lu : t ? Fu : Iu)(n, t));
}
//#endregion
...
function Hu(e) {
	return arguments.length ? this.each(e == null ? zu : (typeof e == "function" ? Vu : Bu)(e)) : this.node().textContent;
}
//#endregion
...
function Ku(e) {
	return arguments.length ? this.each(e == null ? Uu : (typeof e == "function" ? Gu : Wu)(e)) : this.node().innerHTML;
}
//#endregion
...
function Zu(e) {
	var t = typeof e == "function" ? e : El(e);
...
function $u(e, t) {
	var n = typeof e == "function" ? e : El(e), r = t == null ? Qu : typeof t == "function" ? t : Ol(t);
	return this.select(function() {
...
function ud(e, t, n) {
	...
	for (s = t ? ld : cd, i = 0; i < a; ++i) this.each(s(r[i], t, n));
	return this;
}
//#endregion
//#region node_modules/d3-selection/src/selection/dispatch.js
function dd(e, t, n) {
	var r = bu(e), i = r.CustomEvent;
...
function md(e, t) {
	return this.each((typeof t == "function" ? pd : fd)(e, t));
}
//#endregion
...
function vd() {
	return new _d([[document.documentElement]], gd);
}
function yd() {
	return this;
}
_d.prototype = vd.prototype = {
	constructor: _d,
	select: kl,
	selectAll: Pl,
	selectChild: Bl,
...
function bd(e) {
	return typeof e == "string" ? new _d([[document.querySelector(e)]], [document.documentElement]) : new _d([[e]], gd);
}
//#endregion
...
function Dd(e) {
	var t = e.document.documentElement, n = bd(e).on("dragstart.drag", Ed, wd);
	"onselectstart" in t ? n.on("selectstart.drag", Ed, wd) : (t.__noselect = t.style.MozUserSelect, t.style.MozUserSelect = "none");
}
function Od(e, t) {
	var n = e.document.documentElement, r = bd(e).on("dragstart.drag", null);
	t && (r.on("click.drag", Ed, wd), setTimeout(function() {
...
function Ad(e, { sourceEvent: t, subject: n, target: r, identifier: i, active: a, x: o, y: s, dx: c, dy: l, dispatch: u }) {
...
function Fd() {
	var e = jd, t = Md, n = Nd, r = Pd, i = {}, a = _l("start", "drag", "end"), o = 0, s, c, l, u, d = 0;
	function f(e) {
		e.on("mousedown.drag", p).filter(r).on("touchstart.drag", g).on("touchmove.drag", _, Cd).on("touchend.drag touchcancel.drag", v).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
	}
	function p(n, r) {
		if (!(u || !e.call(this, n, r))) {
			var i = y(this, t.call(this, n, r), n, r, "mouse");
			i && (bd(n.view).on("mousemove.drag", m, wd).on("mouseup.drag", h, wd), Dd(n.view), Td(n), l = !1, s = n.clientX, c = n.clientY, i("start", n));
		}
	}
	function m(e) {
		if (Ed(e), !l) {
	...
	function h(e) {
		bd(e.view).on("mousemove.drag mouseup.drag", null), Od(e.view, l), Ed(e), i.mouse("end", e);
	}
	function g(n, r) {
		if (e.call(this, n, r)) {
			var i = n.changedTouches, a = t.call(this, n, r), o = i.length, s, c;
			for (s = 0; s < o; ++s) (c = y(this, a, n, r, i[s].identifier, i[s])) && (Td(n), c("start", n, i[s]));
		}
	}
	function _(e) {
		var t = e.changedTouches, n = t.length, r, a;
		for (r = 0; r < n; ++r) (a = i[t[r].identifier]) && (Ed(e), a("drag", e, t[r]));
	}
	function v(e) {
		var t = e.changedTouches, n = t.length, r, a;
		for (u && clearTimeout(u), u = setTimeout(function() {
			u = null;
		}, 500), r = 0; r < n; ++r) (a = i[t[r].identifier]) && (Td(e), a("end", e, t[r]));
	}
	function y(e, t, r, s, c, l) {
		var u = a.copy(), d = Sd(l || r, t), p, m, h;
		if ((h = n.call(e, new Ad("beforestart", {
			sourceEvent: r,
			target: f,
			identifier: c,
			active: o,
	...
	return f.filter = function(t) {
		return arguments.length ? (e = typeof t == "function" ? t : kd(!!t), f) : e;
	}, f.container = function(e) {
		return arguments.length ? (t = typeof e == "function" ? e : kd(e), f) : t;
	}, f.subject = function(e) {
		return arguments.length ? (n = typeof e == "function" ? e : kd(e), f) : n;
	}, f.touchable = function(e) {
		return arguments.length ? (r = typeof e == "function" ? e : kd(!!e), f) : r;
	}, f.on = function() {
...
function Rd() {}
var zd = .7, Bd = 1 / zd, Vd = "\\s*([+-]?\\d+)\\s*", Hd = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Ud = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Wd = /^#([0-9a-f]{3,8})$/, Gd = RegExp(`^rgb\\(${Vd},${Vd},${Vd}\\)$`), Kd = RegExp(`^rgb\\(${Ud},${Ud},${Ud}\\)$`), qd = RegExp(`^rgba\\(${Vd},${Vd},${Vd},${Hd}\\)$`), Jd = RegExp(`^rgba\\(${Ud},${Ud},${Ud},${Hd}\\)$`), Yd = RegExp(`^hsl\\(${Hd},${Ud},${Ud}\\)$`), Xd = RegExp(`^hsla\\(${Hd},${Ud},${Ud},${Hd}\\)$`), Zd = {
	aliceblue: 15792383,
...
function nf(e) {
	var t, n;
	return e = (e + "").trim().toLowerCase(), (t = Wd.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), n === 6 ? rf(t) : n === 3 ? new cf(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : n === 8 ? af(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : n === 4 ? af(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = Gd.exec(e)) ? new cf(t[1], t[2], t[3], 1) : (t = Kd.exec(e)) ? new cf(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = qd.exec(e)) ? af(t[1], t[2], t[3], t[4]) : (t = Jd.exec(e)) ? af(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = Yd.exec(e)) ? hf(t[1], t[2] / 100, t[3] / 100, 1) : (t = Xd.exec(e)) ? hf(t[1], t[2] / 100, t[3] / 100, t[4]) : Zd.hasOwnProperty(e) ? rf(Zd[e]) : e === "transparent" ? new cf(NaN, NaN, NaN, 0) : null;
}
function rf(e) {
	return new cf(e >> 16 & 255, e >> 8 & 255, e & 255, 1);
}
function af(e, t, n, r) {
	return r <= 0 && (e = t = n = NaN), new cf(e, t, n, r);
}
function of(e) {
	return e instanceof Rd || (e = nf(e)), e ? (e = e.rgb(), new cf(e.r, e.g, e.b, e.opacity)) : new cf();
}
function sf(e, t, n, r) {
	return arguments.length === 1 ? of(e) : new cf(e, t, n, r ?? 1);
}
function cf(e, t, n, r) {
...
Id(cf, sf, Ld(Rd, {
	brighter(e) {
		return e = e == null ? Bd : Bd ** +e, new cf(this.r * e, this.g * e, this.b * e, this.opacity);
	},
	darker(e) {
		return e = e == null ? zd : zd ** +e, new cf(this.r * e, this.g * e, this.b * e, this.opacity);
	},
	rgb() {
		return this;
	},
	clamp() {
		return new cf(pf(this.r), pf(this.g), pf(this.b), ff(this.opacity));
	},
	displayable() {
...
function lf() {
	return `#${mf(this.r)}${mf(this.g)}${mf(this.b)}`;
}
function uf() {
	return `#${mf(this.r)}${mf(this.g)}${mf(this.b)}${mf((isNaN(this.opacity) ? 1 : this.opacity) * 255)}`;
}
function df() {
	let e = ff(this.opacity);
	return `${e === 1 ? "rgb(" : "rgba("}${pf(this.r)}, ${pf(this.g)}, ${pf(this.b)}${e === 1 ? ")" : `, ${e})`}`;
}
function ff(e) {
...
function mf(e) {
	return e = pf(e), (e < 16 ? "0" : "") + e.toString(16);
}
function hf(e, t, n, r) {
	return r <= 0 ? e = t = n = NaN : n <= 0 || n >= 1 ? e = t = NaN : t <= 0 && (e = NaN), new vf(e, t, n, r);
}
function gf(e) {
	if (e instanceof vf) return new vf(e.h, e.s, e.l, e.opacity);
	if (e instanceof Rd || (e = nf(e)), !e) return new vf();
	if (e instanceof vf) return e;
	e = e.rgb();
	var t = e.r / 255, n = e.g / 255, r = e.b / 255, i = Math.min(t, n, r), a = Math.max(t, n, r), o = NaN, s = a - i, c = (a + i) / 2;
	return s ? (o = t === a ? (n - r) / s + (n < r) * 6 : n === a ? (r - t) / s + 2 : (t - n) / s + 4, s /= c < .5 ? a + i : 2 - a - i, o *= 60) : s = c > 0 && c < 1 ? 0 : o, new vf(o, s, c, e.opacity);
}
function _f(e, t, n, r) {
	return arguments.length === 1 ? gf(e) : new vf(e, t, n, r ?? 1);
}
function vf(e, t, n, r) {
...
Id(vf, _f, Ld(Rd, {
	brighter(e) {
		return e = e == null ? Bd : Bd ** +e, new vf(this.h, this.s, this.l * e, this.opacity);
	},
	darker(e) {
		return e = e == null ? zd : zd ** +e, new vf(this.h, this.s, this.l * e, this.opacity);
	},
	rgb() {
		var e = this.h % 360 + (this.h < 0) * 360, t = isNaN(e) || isNaN(this.s) ? 0 : this.s, n = this.l, r = n + (n < .5 ? n : 1 - n) * t, i = 2 * n - r;
		return new cf(xf(e >= 240 ? e - 240 : e + 120, i, r), xf(e, i, r), xf(e < 120 ? e + 240 : e - 120, i, r), this.opacity);
	},
	clamp() {
		return new vf(yf(this.h), bf(this.s), bf(this.l), ff(this.opacity));
	},
	displayable() {
	...
	formatHsl() {
		let e = ff(this.opacity);
		return `${e === 1 ? "hsl(" : "hsla("}${yf(this.h)}, ${bf(this.s) * 100}%, ${bf(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
	}
}));
function yf(e) {
...
function Tf(e) {
	return (e = +e) == 1 ? Ef : function(t, n) {
		return n - t ? wf(t, n, e) : Sf(isNaN(t) ? n : t);
	};
}
function Ef(e, t) {
	var n = t - e;
	return n ? Cf(e, n) : Sf(isNaN(e) ? t : e);
}
//#endregion
...
var Df = (function e(t) {
	var n = Tf(t);
	function r(e, t) {
		var r = n((e = sf(e)).r, (t = sf(t)).r), i = n(e.g, t.g), a = n(e.b, t.b), o = Ef(e.opacity, t.opacity);
		return function(t) {
...
function Nf(e, t) {
	var n = {}, r = {}, i;
	for (i in (typeof e != "object" || !e) && (e = {}), (typeof t != "object" || !t) && (t = {}), t) i in e ? n[i] = zf(e[i], t[i]) : r[i] = t[i];
	return function(e) {
...
var Pf = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Ff = new RegExp(Pf.source, "g");
function If(e) {
	return function() {
		return e;
	};
...
function Rf(e, t) {
	var n = Pf.lastIndex = Ff.lastIndex = 0, r, i, a, o = -1, s = [], c = [];
	for (e += "", t += ""; (r = Pf.exec(e)) && (i = Ff.exec(t));) (a = i.index) > n && (a = t.slice(n, a), s[o] ? s[o] += a : s[++o] = a), (r = r[0]) === (i = i[0]) ? s[o] ? s[o] += i : s[++o] = i : (s[++o] = null, c.push({
		i: o,
		x: Mf(r, i)
	})), n = Ff.lastIndex;
	return n < t.length && (a = t.slice(n), s[o] ? s[o] += a : s[++o] = a), s.length < 2 ? c[0] ? Lf(c[0].x) : If(t) : (t = c.length, function(e) {
...
function zf(e, t) {
	var n = typeof t, r;
	return t == null || n === "boolean" ? Sf(t) : (n === "number" ? Mf : n === "string" ? (r = nf(t)) ? (t = r, Df) : Rf : t instanceof nf ? Df : t instanceof Date ? jf : kf(t) ? Of : Array.isArray(t) ? Af : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? Nf : Mf)(e, t);
}
//#endregion
//#region node_modules/d3-interpolate/src/transform/decompose.js
var Bf = 180 / Math.PI, Vf = {
	translateX: 0,
	translateY: 0,
	rotate: 0,
	skewX: 0,
...
function Hf(e, t, n, r, i, a) {
	...
	return (o = Math.sqrt(e * e + t * t)) && (e /= o, t /= o), (c = e * n + t * r) && (n -= e * c, r -= t * c), (s = Math.sqrt(n * n + r * r)) && (n /= s, r /= s, c /= s), e * r < t * n && (e = -e, t = -t, c = -c, o = -o), {
		translateX: i,
		translateY: a,
		rotate: Math.atan2(t, e) * Bf,
		skewX: Math.atan(c) * Bf,
		scaleX: o,
		scaleY: s
	};
}
...
function Wf(e) {
	...
	return t.isIdentity ? Vf : Hf(t.a, t.b, t.c, t.d, t.e, t.f);
}
function Gf(e) {
	return e == null || (Uf ||= document.createElementNS("http://www.w3.org/2000/svg", "g"), Uf.setAttribute("transform", e), !(e = Uf.transform.baseVal.consolidate())) ? Vf : (e = e.matrix, Hf(e.a, e.b, e.c, e.d, e.e, e.f));
}
//#endregion
...
var qf = Kf(Wf, "px, ", "px)", "deg)"), Jf = Kf(Gf, ", ", ")", ")"), Yf = 1e-12;
function Xf(e) {
...
var $f = (function e(t, n, r) {
	function i(e, i) {
		...
		if (p < Yf) h = Math.log(u / s) / t, m = function(e) {
			return [
				a + e * d,
				o + e * f,
				s * Math.exp(t * e * h)
			...
			h = (Math.log(Math.sqrt(v * v + 1) - v) - y) / t, m = function(e) {
				var r = e * h, i = Xf(y), c = s / (n * g) * (i * Qf(t * r + y) - Zf(y));
				return [
					a + c * d,
					o + c * f,
					s * i / Xf(t * r + y)
...
})(Math.SQRT2, 2, 4), ep = 0, tp = 0, np = 0, rp = 1e3, ip, ap, op = 0, sp = 0, cp = 0, lp = typeof performance == "object" && performance.now ? performance : Date, up = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
	setTimeout(e, 17);
};
function dp() {
	return sp ||= (up(fp), lp.now() + cp);
}
function fp() {
	sp = 0;
}
...
pp.prototype = mp.prototype = {
	constructor: pp,
	restart: function(e, t, n) {
		if (typeof e != "function") throw TypeError("callback is not a function");
		n = (n == null ? dp() : +n) + (t == null ? 0 : +t), !this._next && ap !== this && (ap ? ap._next = this : ip = this, ap = this), this._call = e, this._time = n, yp();
	},
	stop: function() {
		this._call && (this._call = null, this._time = Infinity, yp());
	}
};
function mp(e, t, n) {
	var r = new pp();
...
function hp() {
	dp(), ++ep;
	for (var e = ip, t; e;) (t = sp - e._time) >= 0 && e._call.call(void 0, t), e = e._next;
	--ep;
}
function gp() {
	sp = (op = lp.now()) + cp, ep = tp = 0;
	try {
		hp();
	} finally {
		ep = 0, vp(), sp = 0;
...
function vp() {
	for (var e, t = ip, n, r = Infinity; t;) t._call ? (r > t._time && (r = t._time), e = t, t = t._next) : (n = t._next, t._next = null, t = e ? e._next = n : ip = n);
	ap = e, yp(r);
}
function yp(e) {
	ep || (tp &&= clearTimeout(tp), e - sp > 24 ? (e < Infinity && (tp = setTimeout(gp, e - lp.now() - cp)), np &&= clearInterval(np)) : (np ||= (op = lp.now(), setInterval(_p, rp)), ep = 1, up(gp)));
}
//#endregion
...
var xp = _l("start", "end", "cancel", "interrupt"), Sp = [];
...
function Mp(e, t) {
	...
	if (e += "", arguments.length < 2) {
		for (var r = Ep(this.node(), n).tween, i = 0, a = r.length, o; i < a; ++i) if ((o = r[i]).name === e) return o.value;
		return null;
	}
	return this.each((t == null ? Ap : jp)(n, e, t));
}
function Np(e, t, n) {
	var r = e._id;
...
function Pp(e, t) {
	var n;
	return (typeof t == "number" ? Mf : t instanceof nf ? Df : (n = nf(t)) ? (t = n, Df) : Rf)(e, t);
}
//#endregion
...
function Vp(e, t) {
	var n = Cl(e), r = n === "transform" ? Jf : Pp;
	return this.attrTween(e, typeof t == "function" ? (n.local ? Bp : zp)(n, r, Np(this, "attr." + e, t)) : t == null ? (n.local ? Ip : Fp)(n) : (n.local ? Rp : Lp)(n, r, t));
}
//#endregion
...
function Kp(e, t) {
	...
	var r = Cl(e);
	return this.tween(n, (r.local ? Wp : Gp)(r, t));
}
//#endregion
//#region node_modules/d3-transition/src/transition/delay.js
function qp(e, t) {
	return function() {
		wp(this, e).delay = +t.apply(this, arguments);
	};
}
function Jp(e, t) {
	return t = +t, function() {
...
function Yp(e) {
	var t = this._id;
	return arguments.length ? this.each((typeof e == "function" ? qp : Jp)(t, e)) : Ep(this.node(), t).delay;
}
//#endregion
//#region node_modules/d3-transition/src/transition/duration.js
function Xp(e, t) {
	return function() {
		Tp(this, e).duration = +t.apply(this, arguments);
	};
}
function Zp(e, t) {
	return t = +t, function() {
		Tp(this, e).duration = t;
	};
}
function Qp(e) {
	var t = this._id;
	return arguments.length ? this.each((typeof e == "function" ? Xp : Zp)(t, e)) : Ep(this.node(), t).duration;
}
//#endregion
...
function em(e) {
	var t = this._id;
	return arguments.length ? this.each($p(t, e)) : Ep(this.node(), t).ease;
}
//#endregion
...
function rm(e) {
	typeof e != "function" && (e = Fl(e));
	for (var t = this._groups, n = t.length, r = Array(n), i = 0; i < n; ++i) for (var a = t[i], o = a.length, s = r[i] = [], c, l = 0; l < o; ++l) (c = a[l]) && e.call(c, c.__data__, l, a) && s.push(c);
	return new Mm(r, this._parents, this._name, this._id);
}
//#endregion
...
function im(e) {
	...
	for (; s < r; ++s) o[s] = t[s];
	return new Mm(o, this._parents, this._name, this._id);
}
//#endregion
...
function sm(e, t) {
	var n = this._id;
	return arguments.length < 2 ? Ep(this.node(), n).on.on(e) : this.each(om(n, e, t));
}
//#endregion
...
function um(e) {
	...
	typeof e != "function" && (e = Ol(e));
	for (var r = this._groups, i = r.length, a = Array(i), o = 0; o < i; ++o) for (var s = r[o], c = s.length, l = a[o] = Array(c), u, d, f = 0; f < c; ++f) (u = s[f]) && (d = e.call(u, u.__data__, f, s)) && ("__data__" in u && (d.__data__ = u.__data__), l[f] = d, Cp(l[f], t, n, f, l, Ep(u, n)));
	return new Mm(a, this._parents, t, n);
}
//#endregion
...
function dm(e) {
	...
	for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s) for (var c = r[s], l = c.length, u, d = 0; d < l; ++d) if (u = c[d]) {
		for (var f = e.call(u, u.__data__, d, c), p, m = Ep(u, n), h = 0, g = f.length; h < g; ++h) (p = f[h]) && Cp(p, t, n, h, f, m);
		a.push(f), o.push(u);
	}
	return new Mm(a, o, t, n);
}
//#endregion
//#region node_modules/d3-transition/src/transition/selection.js
var fm = vd.prototype.constructor;
function pm() {
...
function mm(e, t) {
	var n, r, i;
	return function() {
		var a = Tu(this, e), o = (this.style.removeProperty(e), Tu(this, e));
...
function _m(e, t, n) {
	var r, i, a;
	return function() {
		var o = Tu(this, e), s = n(this), c = s + "";
		return s ?? (c = s = (this.style.removeProperty(e), Tu(this, e))), o === c ? null : o === r && c === i ? a : (i = c, a = t(r = o, s));
	};
}
function vm(e, t) {
	var n, r, i, a = "style." + t, o = "end." + a, s;
	return function() {
		var c = Tp(this, e), l = c.on, u = c.value[a] == null ? s ||= hm(t) : void 0;
		(l !== n || i !== u) && (r = (n = l).copy()).on(o, i = u), c.on = r;
	};
}
function ym(e, t, n) {
	var r = (e += "") == "transform" ? qf : Pp;
	return t == null ? this.styleTween(e, mm(e, r)).on("end.style." + e, hm(e)) : typeof t == "function" ? this.styleTween(e, _m(e, r, Np(this, "style." + e, t))).each(vm(this._id, e)) : this.styleTween(e, gm(e, r, t), n).on("end.style." + e, null);
}
//#endregion
...
function Tm(e) {
	return this.tween("text", typeof e == "function" ? wm(Np(this, "text", e)) : Cm(e == null ? "" : e + ""));
}
//#endregion
...
function Om(e) {
	...
	if (typeof e != "function") throw Error();
	return this.tween(t, Dm(e));
}
//#endregion
//#region node_modules/d3-transition/src/transition/transition.js
function km() {
	for (var e = this._name, t = this._id, n = Nm(), r = this._groups, i = r.length, a = 0; a < i; ++a) for (var o = r[a], s = o.length, c, l = 0; l < s; ++l) if (c = o[l]) {
		var u = Ep(c, t);
		Cp(c, e, n, l, o, {
	...
	return new Mm(r, this._parents, e, n);
}
//#endregion
...
Mm.prototype = {
	...
	[Symbol.iterator]: Pm[Symbol.iterator]
};
//#endregion
...
function Rm(e) {
	var t, n;
	e instanceof Mm ? (t = e._id, e = e._name) : (t = Nm(), (n = Im).time = dp(), e = e == null ? null : e + "");
	for (var r = this._groups, i = r.length, a = 0; a < i; ++a) for (var o = r[a], s = o.length, c, l = 0; l < s; ++l) (c = o[l]) && Cp(c, e, t, l, o, n || Lm(c, t));
	return new Mm(r, this._parents, e, t);
}
vd.prototype.interrupt = kp, vd.prototype.transition = Rm;
//#endregion
//#region node_modules/d3-zoom/src/constant.js
var zm = (e) => () => e;
//#endregion
//#region node_modules/d3-zoom/src/event.js
function Bm(e, { sourceEvent: t, target: n, transform: r, dispatch: i }) {
	Object.defineProperties(this, {
		type: {
			value: e,
			enumerable: !0,
...
Vm.prototype = {
	constructor: Vm,
	scale: function(e) {
		return e === 1 ? this : new Vm(this.k * e, this.x, this.y);
	},
	translate: function(e, t) {
		return e === 0 & t === 0 ? this : new Vm(this.k, this.x + this.k * e, this.y + this.k * t);
	},
	apply: function(e) {
...
var Hm = new Vm(1, 0, 0);
Um.prototype = Vm.prototype;
function Um(e) {
	for (; !e.__zoom;) if (!(e = e.parentNode)) return Hm;
	return e.__zoom;
}
//#endregion
...
function Qm() {
	var e = Km, t = qm, n = Zm, r = Ym, i = Xm, a = [0, Infinity], o = [[-Infinity, -Infinity], [Infinity, Infinity]], s = 250, c = $f, l = _l("start", "zoom", "end"), u, d, f, p = 500, m = 150, h = 0, g = 10;
	function _(e) {
		e.property("__zoom", Jm).on("wheel.zoom", w, { passive: !1 }).on("mousedown.zoom", T).on("dblclick.zoom", E).filter(i).on("touchstart.zoom", D).on("touchmove.zoom", O).on("touchend.zoom touchcancel.zoom", k).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
	}
	_.transform = function(e, t, n, r) {
		var i = e.selection ? e.selection() : e;
		i.property("__zoom", Jm), e === i ? i.interrupt().each(function() {
		...
		_.transform(e, function() {
			...
			return n(Hm.translate(c[0], c[1]).scale(s.k).translate(typeof r == "function" ? -r.apply(this, arguments) : -r, typeof i == "function" ? -i.apply(this, arguments) : -i), e, o);
		}, a, s);
	};
	function v(e, t) {
		return t = Math.max(a[0], Math.min(a[1], t)), t === e.k ? e : new Vm(t, e.x, e.y);
	}
	function y(e, t, n) {
		var r = t[0] - n[0] * e.k, i = t[1] - n[1] * e.k;
		return r === e.x && i === e.y ? e : new Vm(e.k, r, i);
	}
	function b(e) {
		...
		e.on("start.zoom", function() {
			...
			return function(e) {
				if (e === 1) e = f;
					...
					var t = p(e), n = u / t[2];
					e = new Vm(n, l[0] - t[0] * n, l[1] - t[1] * n);
				}
				o.zoom(null, e);
			};
		});
	...
	C.prototype = {
		...
		emit: function(e) {
			var t = bd(this.that).datum();
			l.call(e, this.that, new Bm(e, {
	...
	function w(t, ...i) {
		...
		var s = S(this, i).event(t), c = this.__zoom, l = Math.max(a[0], Math.min(a[1], c.k * 2 ** r.apply(this, arguments))), u = Sd(t);
		if (s.wheel) (s.mouse[0][0] !== u[0] || s.mouse[0][1] !== u[1]) && (s.mouse[1] = c.invert(s.mouse[0] = u)), clearTimeout(s.wheel);
		else if (c.k === l) return;
		else s.mouse = [u, c.invert(u)], Op(this), s.start();
		Gm(t), s.wheel = setTimeout(d, m), s.zoom("mouse", n(y(v(c, l), s.mouse[0], s.mouse[1]), s.extent, o));
		function d() {
			s.wheel = null, s.end();
		}
	}
	function T(t, ...r) {
		...
		var i = t.currentTarget, a = S(this, r, !0).event(t), s = bd(t.view).on("mousemove.zoom", d, !0).on("mouseup.zoom", p, !0), c = Sd(t, i), l = t.clientX, u = t.clientY;
		Dd(t.view), Wm(t), a.mouse = [c, this.__zoom.invert(c)], Op(this), a.start();
		function d(e) {
			if (Gm(e), !a.moved) {
				var t = e.clientX - l, r = e.clientY - u;
				a.moved = t * t + r * r > h;
			}
			a.event(e).zoom("mouse", n(y(a.that.__zoom, a.mouse[0] = Sd(e, i), a.mouse[1]), a.extent, o));
		}
		function p(e) {
			s.on("mousemove.zoom mouseup.zoom", null), Od(e.view, a.moved), Gm(e), a.event(e).end();
		}
	}
	function E(r, ...i) {
		if (e.apply(this, arguments)) {
			var a = this.__zoom, c = Sd(r.changedTouches ? r.changedTouches[0] : r, this), l = a.invert(c), u = a.k * (r.shiftKey ? .5 : 2), d = n(y(v(a, u), c, l), t.apply(this, i), o);
			Gm(r), s > 0 ? bd(this).transition().duration(s).call(x, d, c, r) : bd(this).call(_.transform, d, c, r);
		}
	}
	function D(t, ...n) {
		if (e.apply(this, arguments)) {
			var r = t.touches, i = r.length, a = S(this, n, t.changedTouches.length === i).event(t), o, s, c, l;
			for (Wm(t), s = 0; s < i; ++s) c = r[s], l = Sd(c, this), l = [
				l,
	...
	function O(e, ...t) {
		if (this.__zooming) {
			...
			for (Gm(e), s = 0; s < a; ++s) c = i[s], l = Sd(c, this), r.touch0 && r.touch0[2] === c.identifier ? r.touch0[0] = l : r.touch1 && r.touch1[2] === c.identifier && (r.touch1[0] = l);
	...
	function k(e, ...t) {
		if (this.__zooming) {
			...
			for (Wm(e), f && clearTimeout(f), f = setTimeout(function() {
				f = null;
			}, p), a = 0; a < i; ++a) o = r[a], n.touch0 && n.touch0[2] === o.identifier ? delete n.touch0 : n.touch1 && n.touch1[2] === o.identifier && delete n.touch1;
			if (n.touch1 && !n.touch0 && (n.touch0 = n.touch1, delete n.touch1), n.touch0) n.touch0[1] = this.__zoom.invert(n.touch0[0]);
			else if (n.end(), n.taps === 2 && (o = Sd(o, this), Math.hypot(d[0] - o[0], d[1] - o[1]) < g)) {
				var s = bd(this).on("dblclick.zoom");
				s && s.apply(this, arguments);
			}
		}
	}
	return _.wheelDelta = function(e) {
		return arguments.length ? (r = typeof e == "function" ? e : zm(+e), _) : r;
	}, _.filter = function(t) {
		return arguments.length ? (e = typeof t == "function" ? t : zm(!!t), _) : e;
	}, _.touchable = function(e) {
		return arguments.length ? (i = typeof e == "function" ? e : zm(!!e), _) : i;
	}, _.extent = function(e) {
		return arguments.length ? (t = typeof e == "function" ? e : zm([[+e[0][0], +e[0][1]], [+e[1][0], +e[1][1]]]), _) : t;
...
}, eh = [[-Infinity, -Infinity], [Infinity, Infinity]], th = [
	"Enter",
	" ",
	"Escape"
], nh = {
...
var uh = {
	...
	[lh.Top]: lh.Bottom,
	[lh.Bottom]: lh.Top
}, dh = (e) => !!e && typeof e == "object" && "id" in e && "source" in e && "target" in e, fh = (e) => !!e && typeof e == "object" && "id" in e && "position" in e && !("source" in e) && !("target" in e), ph = (e) => !!e && typeof e == "object" && "id" in e && "internals" in e && !("source" in e) && !("target" in e), mh = (e, t = [0, 0]) => {
	let { width: n, height: r } = Jh(e), i = e.origin ?? t, a = n * i[0], o = r * i[1];
	return {
		x: e.position.x - a,
		y: e.position.y - o
	};
	...
	let n = !1, r = e.reduce((e, r) => {
		...
		return t.nodeLookup && (a = i ? t.nodeLookup.get(r) : ph(r) ? r : t.nodeLookup.get(r.id)), a ? (n = !0, Oh(e, Mh(a, t.nodeOrigin))) : e;
	}, {
		x: Infinity,
		y: Infinity,
		x2: -Infinity,
	...
	return e.forEach((e) => {
		(t.filter === void 0 || t.filter(e)) && (n = Oh(n, Mh(e)), r = !0);
	}), r ? Ah(n) : {
		x: 0,
		y: 0,
		width: 0,
	...
	for (let t of e.values()) {
		...
		if (o && !n || r) continue;
		let i = e.width ?? t.width ?? t.initialWidth ?? 0, f = e.height ?? t.height ?? t.initialHeight ?? 0, { x: p, y: m } = t.internals.positionAbsolute, h = Ph(s, c, l, u, p, m, i, f), g = i * f, _ = a && h > 0;
...
function yh(e, t) {
	...
	return e.forEach((e) => {
		...
		if (t?.includeHiddenNodes) {
			let { width: t, height: n } = Jh(e);
			i = t > 0 && n > 0;
		} else i = !!(e.measured.width && e.measured.height && !e.hidden);
		i && (!r || r.has(e.id)) && n.set(e.id, e);
	}), n;
}
async function bh({ nodes: e, width: t, height: n, panZoom: r, minZoom: i, maxZoom: a }, o) {
	if (e.size === 0) return !0;
	let s = Gh(gh(yh(e, o)), t, n, o?.minZoom ?? i, o?.maxZoom ?? a, o?.padding ?? .1);
...
function xh({ nodeId: e, nextPosition: t, nodeLookup: n, nodeOrigin: r = [0, 0], nodeExtent: i, onError: a }) {
	...
	if (o.extent === "parent" && !o.expandParent) {
		if (!s) a?.("005", $m.error005());
		else {
			let { width: e, height: t } = Jh(s);
			e && t && (d = [[c, l], [c + e, l + t]]);
		}
	} else s && qh(o.extent) && (d = [[o.extent[0][0] + c, o.extent[0][1] + l], [o.extent[1][0] + c, o.extent[1][1] + l]]);
	let f = qh(d) ? wh(t, d, o.measured) : t;
	return (o.measured.width === void 0 || o.measured.height === void 0) && a?.("015", $m.error015()), {
		position: {
...
async function Sh({ nodesToRemove: e = [], edgesToRemove: t = [], nodes: n, edges: r, onBeforeDelete: i }) {
	...
	let s = new Set(t.map((e) => e.id)), c = r.filter((e) => e.deletable !== !1), l = vh(o, c);
...
var Ch = (e, t = 0, n = 1) => Math.min(Math.max(e, t), n), wh = (e = {
	x: 0,
	y: 0
}, t, n) => ({
	x: Ch(e.x, t[0][0], t[1][0] - (n?.width ?? 0)),
	y: Ch(e.y, t[0][1], t[1][1] - (n?.height ?? 0))
});
function Th(e, t, n) {
	let { width: r, height: i } = Jh(n), { x: a, y: o } = n.internals.positionAbsolute;
	return wh(e, [[a, o], [a + r, o + i]], t);
}
var Eh = (e, t, n) => e < t ? Ch(Math.abs(e - t), 1, t) / t : e > n ? -Ch(Math.abs(e - n), 1, t) / t : 0, Dh = (e, t, n = 15, r = 40) => [Eh(e.x, r, t.width - r) * n, Eh(e.y, r, t.height - r) * n], Oh = (e, t) => ({
	x: Math.min(e.x, t.x),
	y: Math.min(e.y, t.y),
	x2: Math.max(e.x2, t.x2),
	y2: Math.max(e.y2, t.y2)
}), kh = ({ x: e, y: t, width: n, height: r }) => ({
	x: e,
	y: t,
	x2: e + n,
	y2: t + r
}), Ah = ({ x: e, y: t, x2: n, y2: r }) => ({
	x: e,
	y: t,
	width: n - e,
	height: r - t
}), jh = (e, t = [0, 0]) => {
	let { x: n, y: r } = ph(e) ? e.internals.positionAbsolute : mh(e, t);
	return {
		x: n,
		y: r,
...
}, Nh = (e, t) => Ah(Oh(kh(e), kh(t))), Ph = (e, t, n, r, i, a, o, s) => {
	let c = Math.max(0, Math.min(e + n, i + o) - Math.max(e, i)), l = Math.max(0, Math.min(t + r, a + s) - Math.max(t, a));
	return Math.ceil(c * l);
}, Fh = (e, t) => Ph(e.x, e.y, e.width, e.height, t.x, t.y, t.width, t.height), Ih = (e) => Lh(e.width) && Lh(e.height) && Lh(e.x) && Lh(e.y), Lh = (e) => !isNaN(e) && isFinite(e), Rh = (e, t) => (e, t) => {}, zh = (e, t = [1, 1]) => ({
	x: t[0] * Math.round(e.x / t[0]),
	y: t[1] * Math.round(e.y / t[1])
}), Bh = ({ x: e, y: t }, [n, r, i], a = !1, o = [1, 1]) => {
	let s = {
		x: (e - n) / i,
		y: (t - r) / i
	};
...
function Uh(e, t, n) {
	...
	if (typeof e == "object") {
		let r = Hh(e.top ?? e.y ?? 0, n), i = Hh(e.bottom ?? e.y ?? 0, n), a = Hh(e.left ?? e.x ?? 0, t), o = Hh(e.right ?? e.x ?? 0, t);
		return {
			top: r,
			right: o,
			bottom: i,
...
var Gh = (e, t, n, r, i, a) => {
	let o = Uh(a, t, n), s = (t - o.x) / e.width, c = (n - o.y) / e.height, l = Ch(Math.min(s, c), r, i), u = e.x + e.width / 2, d = e.y + e.height / 2, f = t / 2 - u * l, p = n / 2 - d * l, m = Wh(e, f, p, l, t, n), h = {
...
function tg(e, { snapGrid: t = [0, 0], snapToGrid: n = !1, transform: r, containerBounds: i }) {
	let { x: a, y: o } = sg(e), s = Bh({
		x: a - (i?.left ?? 0),
		y: o - (i?.top ?? 0)
	}, r), { x: c, y: l } = n ? zh(s, t) : s;
	return {
		xSnapped: c,
		ySnapped: l,
		...s
...
}), rg = (e) => e?.getRootNode?.() || window?.document, ig = [
	"INPUT",
	"SELECT",
	"TEXTAREA"
];
function ag(e) {
	...
	return t?.nodeType === 1 ? ig.includes(t.nodeName) || t.hasAttribute("contenteditable") || !!t.closest(".nokey") : !1;
}
var og = (e) => "clientX" in e, sg = (e, t) => {
	let n = og(e), r = n ? e.clientX : e.touches?.[0].clientX, i = n ? e.clientY : e.touches?.[0].clientY;
	return {
		x: r - (t?.left ?? 0),
		y: i - (t?.top ?? 0)
	};
...
function lg({ sourceX: e, sourceY: t, targetX: n, targetY: r, sourceControlX: i, sourceControlY: a, targetControlX: o, targetControlY: s }) {
...
function dg({ pos: e, x1: t, y1: n, x2: r, y2: i, c: a }) {
	switch (e) {
		case lh.Left: return [t - ug(t - r, a), n];
		case lh.Right: return [t + ug(r - t, a), n];
		case lh.Top: return [t, n - ug(n - i, a)];
		case lh.Bottom: return [t, n + ug(i - n, a)];
	}
}
function fg({ sourceX: e, sourceY: t, sourcePosition: n = lh.Bottom, targetX: r, targetY: i, targetPosition: a = lh.Top, curvature: o = .25 }) {
	let [s, c] = dg({
		pos: n,
		x1: e,
		y1: t,
...
function mg({ sourceNode: e, targetNode: t, selected: n = !1, zIndex: r = 0, elevateOnSelect: i = !1, zIndexMode: a = "basic" }) {
	return a === "manual" ? r : (i && n ? r + 1e3 : r) + Math.max(e.parentId || i && e.selected ? e.internals.z : 0, t.parentId || i && t.selected ? t.internals.z : 0);
}
function hg({ sourceNode: e, targetNode: t, width: n, height: r, transform: i }) {
	let a = Oh(Mh(e), Mh(t));
	return a.x === a.x2 && (a.x2 += 1), a.y === a.y2 && (a.y2 += 1), Fh({
		x: -i[0] / i[2],
		y: -i[1] / i[2],
		width: n / i[2],
		height: r / i[2]
...
var gg = ({ source: e, sourceHandle: t, target: n, targetHandle: r }) => `xy-edge__${e}${t || ""}-${n}${r || ""}`, _g = (e, t) => t.some((t) => t.source === e.source && t.target === e.target && (t.sourceHandle === e.sourceHandle || !t.sourceHandle && !e.sourceHandle) && (t.targetHandle === e.targetHandle || !t.targetHandle && !e.targetHandle)), vg = (e, t, n = {}) => {
	if (!e.source || !e.target) return n.onError?.("006", $m.error006()), t;
	let r = n.getEdgeId || gg, i;
	return i = dh(e) ? { ...e } : {
		...e,
		id: r(e)
	}, _g(i, t) ? t : (i.sourceHandle === null && delete i.sourceHandle, i.targetHandle === null && delete i.targetHandle, t.concat(i));
};
...
var bg = {
...
}, xg = ({ source: e, sourcePosition: t = lh.Bottom, target: n }) => t === lh.Left || t === lh.Right ? e.x < n.x ? {
	x: 1,
	y: 0
} : {
	x: -1,
	...
	x: 0,
	y: -1
}, Sg = (e, t) => Math.sqrt((t.x - e.x) ** 2 + (t.y - e.y) ** 2);
function Cg({ source: e, sourcePosition: t = lh.Bottom, target: n, targetPosition: r = lh.Top, center: i, offset: a, stepPosition: o }) {
	let s = bg[t], c = bg[r], l = {
		x: e.x + s.x * a,
		y: e.y + s.y * a
	}, u = {
...
function wg(e, t, n, r) {
	let i = Math.min(Sg(e, t) / 2, Sg(t, n) / 2, r), { x: a, y: o } = t;
...
function Tg({ sourceX: e, sourceY: t, sourcePosition: n = lh.Bottom, targetX: r, targetY: i, targetPosition: a = lh.Top, borderRadius: o = 5, centerX: s, centerY: c, offset: l = 20, stepPosition: u = .5 }) {
	let [d, f, p, m, h] = Cg({
		source: {
			x: e,
			y: t
	...
	for (let e = 1; e < d.length - 1; e++) g += wg(d[e - 1], d[e], d[e + 1], o);
...
function Dg(e) {
	...
	if (!Eg(t) || !Eg(n)) return null;
	let r = t.internals.handleBounds || Og(t.handles), i = n.internals.handleBounds || Og(n.handles), a = Ag(r?.source ?? [], e.sourceHandle), o = Ag(e.connectionMode === rh.Strict ? i?.target ?? [] : (i?.target ?? []).concat(i?.source ?? []), e.targetHandle);
	if (!a || !o) return e.onError?.("008", $m.error008(a ? "target" : "source", {
		id: e.id,
		sourceHandle: e.sourceHandle,
		targetHandle: e.targetHandle
	})), null;
	let s = a?.position || lh.Bottom, c = o?.position || lh.Top, l = kg(t, a, s), u = kg(n, o, c);
	return {
		sourceX: l.x,
		sourceY: l.y,
		targetX: u.x,
...
function kg(e, t, n = lh.Left, r = !1) {
	let i = (t?.x ?? 0) + e.internals.positionAbsolute.x, a = (t?.y ?? 0) + e.internals.positionAbsolute.y, { width: o, height: s } = t ?? Jh(e);
	if (r) return {
		x: i + o / 2,
		y: a + s / 2
	};
	switch (t?.position ?? n) {
		...
		case lh.Right: return {
			x: i + o,
			y: a + s / 2
		};
		case lh.Bottom: return {
			x: i + o / 2,
			y: a + s
		};
		case lh.Left: return {
...
function Mg(e, { id: t, defaultColor: n, defaultMarkerStart: r, defaultMarkerEnd: i }) {
...
function Rg(e, t, n) {
	let r = Lg(Fg, n);
	for (let n of e.values()) if (n.parentId) Ug(n, e, t, r);
	else {
		let e = wh(mh(n, r.nodeOrigin), qh(n.extent) ? n.extent : r.nodeExtent, Jh(n));
...
function Vg(e, t, n, r = {}) {
	let i = Lg(Ig, r), a = { i: 0 }, o = new Map(t), s = i?.elevateNodesOnSelect && !Bg(i.zIndexMode) ? Ng : 0, c = e.length > 0, l = !1;
	t.clear(), n.clear();
	for (let u of e) {
		let e = o.get(u.id);
		if (i.checkEquality && u === e?.internals.userNode) t.set(u.id, e);
		else {
			let n = wh(mh(u, i.nodeOrigin), qh(u.extent) ? u.extent : i.nodeExtent, Jh(u));
			e = {
				...i.defaults,
				...u,
				measured: {
				...
				internals: {
					positionAbsolute: n,
					handleBounds: zg(u, e),
					z: Wg(u, s, i.zIndexMode),
					userNode: u
				}
			}, t.set(u.id, e);
		}
		(e.measured === void 0 || e.measured.width === void 0 || e.measured.height === void 0) && !e.hidden && (c = !1), u.parentId && Ug(e, t, n, r, a), l ||= u.selected ?? !1;
	}
	return {
		nodesInitialized: c,
		hasSelectedNodes: l
...
function Ug(e, t, n, r, i) {
	let { elevateNodesOnSelect: a, nodeOrigin: o, nodeExtent: s, zIndexMode: c } = Lg(Fg, r), l = e.parentId, u = t.get(l);
	if (!u) {
		console.warn(`Parent node ${l} not found. Please make sure that parent nodes are in front of their child nodes in the nodes array.`);
		return;
	}
	Hg(e, n), i && !u.parentId && u.internals.rootParentIndex === void 0 && c === "auto" && (u.internals.rootParentIndex = ++i.i, u.internals.z = u.internals.z + i.i * Pg), i && u.internals.rootParentIndex !== void 0 && (i.i = u.internals.rootParentIndex);
	let { x: d, y: f, z: p } = Gg(e, u, o, s, a && !Bg(c) ? Ng : 0, c), { positionAbsolute: m } = e.internals, h = d !== m.x || f !== m.y;
...
function Wg(e, t, n) {
	let r = Lh(e.zIndex) ? e.zIndex : 0;
	return Bg(n) ? r : r + (e.selected ? t : 0);
}
function Gg(e, t, n, r, i, a) {
	let { x: o, y: s } = t.internals.positionAbsolute, c = Jh(e), l = mh(e, n), u = qh(e.extent) ? wh(l, e.extent, c) : l, d = wh({
		x: o + u.x,
		y: s + u.y
	}, r, c);
	e.extent === "parent" && (d = Th(d, c, t));
	let f = Wg(e, i, a), p = t.internals.z ?? 0;
	return {
		x: d.x,
		y: d.y,
		z: p >= f ? p + 1 : f
...
function Kg(e, t, n, r = [0, 0]) {
	let i = [], a = /* @__PURE__ */ new Map();
	for (let n of e) {
		let e = t.get(n.parentId);
		if (!e) continue;
		let r = Nh(a.get(n.parentId)?.expandedRect ?? jh(e), n.rect);
		a.set(n.parentId, {
			expandedRect: r,
			parent: e
		});
	...
	return a.size > 0 && a.forEach(({ expandedRect: t, parent: a }, o) => {
		let s = a.internals.positionAbsolute, c = Jh(a), l = a.origin ?? r, u = t.x < s.x ? Math.round(Math.abs(s.x - t.x)) : 0, d = t.y < s.y ? Math.round(Math.abs(s.y - t.y)) : 0, f = Math.max(c.width, Math.round(t.width)), p = Math.max(c.height, Math.round(t.height)), m = (f - c.width) * l[0], h = (p - c.height) * l[1];
		(u > 0 || d > 0 || m || h) && (i.push({
			id: o,
			type: "position",
			position: {
...
function qg(e, t, n, r, i, a, o) {
	...
	for (let r of e.values()) {
		...
		let s = ng(r.nodeElement), u = e.measured.width !== s.width || e.measured.height !== s.height;
		if (s.width && s.height && (u || !e.internals.handleBounds || r.force)) {
			let p = r.nodeElement.getBoundingClientRect(), m = qh(e.extent) ? e.extent : a, { positionAbsolute: h } = e.internals;
			...
			let g = {
				...
				internals: {
					...
					positionAbsolute: h,
					handleBounds: {
						source: cg("source", r.nodeElement, p, d, e.id),
						target: cg("target", r.nodeElement, p, d, e.id)
					}
				}
			};
			t.set(e.id, g), e.parentId && Ug(g, t, n, {
				nodeOrigin: i,
				zIndexMode: o
			}), c = !0, u && (l.push({
				id: e.id,
...
async function Jg({ delta: e, panZoom: t, transform: n, translateExtent: r, width: i, height: a }) {
...
function Xg(e, t, n) {
	...
	for (let r of n) {
		...
		Yg("source", s, `${i}-${o}--${n}-${a}`, e, n, a), Yg("target", s, c, e, i, o), t.set(r.id, r);
	}
}
function Zg(e, t) {
	if (!e.parentId) return !1;
	let n = t.get(e.parentId);
	return n ? n.selected ? !0 : Zg(n, t) : !1;
}
function Qg(e, t, n) {
	let r = e;
	do {
...
function $g(e, t, n, r) {
	...
	for (let [a, o] of e) if ((o.selected || o.id === r) && (!o.parentId || !Zg(o, e)) && (o.draggable || t && o.draggable === void 0)) {
		let t = e.get(a);
		t && i.set(a, {
			id: a,
			position: t.position || {
...
function e_({ nodeId: e, dragItems: t, nodeLookup: n, dragging: r = !0 }) {
	let i = [];
	for (let [e, a] of t) {
...
function t_({ dragItems: e, snapGrid: t, x: n, y: r }) {
...
function n_({ onNodeMouseDown: e, getStoreItems: t, onDragStart: n, onDrag: r, onDragStop: i }) {
	let a = {
		x: null,
		y: null
	...
	function g({ noDragClassName: g, handleSelector: _, domNode: v, isSelectable: y, nodeId: b, nodeClickDistance: x = 0 }) {
		...
		function S({ x: e, y: n }) {
			...
			let _ = !1, v = s.size > 1, y = v && o ? kh(gh(s)) : null, x = v && l ? t_({
				dragItems: s,
				snapGrid: c,
				x: e,
				y: n
			...
			for (let [t, r] of s) {
				...
				let { position: d, positionAbsolute: f } = xh({
					nodeId: t,
					nextPosition: a,
					nodeLookup: i,
					nodeExtent: s || o,
		...
		function w(r) {
			...
			let v = tg(r.sourceEvent, {
				transform: l,
				snapGrid: f,
				snapToGrid: p,
				containerBounds: u
			});
			if (a = v, s = $g(i, c, v, b), s.size > 0 && (n || h || !b && g)) {
				let [e, t] = e_({
					nodeId: b,
					dragItems: s,
					nodeLookup: i
		...
		let T = Fd().clickDistance(x).on("start", (e) => {
			let { domNode: n, nodeDragThreshold: r, transform: i, snapGrid: o, snapToGrid: s } = t();
			u = n?.getBoundingClientRect() || null, p = !1, m = !1, h = e.sourceEvent, r === 0 && w(e), a = tg(e.sourceEvent, {
				transform: i,
				snapGrid: o,
				snapToGrid: s,
				containerBounds: u
			}), l = sg(e.sourceEvent, u);
		}).on("drag", (e) => {
			let { autoPanOnNodeDrag: n, transform: r, snapGrid: i, snapToGrid: o, nodeDragThreshold: f, nodeLookup: m } = t(), g = tg(e.sourceEvent, {
				transform: r,
				snapGrid: i,
				snapToGrid: o,
				containerBounds: u
			...
			if (h = e.sourceEvent, (e.sourceEvent.type === "touchmove" && e.sourceEvent.touches.length > 1 || b && !m.has(b)) && (p = !0), !p) {
				if (!c && n && d && (c = !0, C()), !d) {
					let t = sg(e.sourceEvent, u), n = t.x - l.x, r = t.y - l.y;
					Math.sqrt(n * n + r * r) > f && w(e);
				}
				(a.x !== g.xSnapped || a.y !== g.ySnapped) && s && d && (l = sg(e.sourceEvent, u), S(g));
			}
		}).on("end", (e) => {
			if (!d || p) {
			...
			let t = e.target;
			return !e.button && (!g || !Qg(t, `.${g}`, v)) && (!_ || Qg(t, _, v));
		});
		f.call(T);
	}
	function _() {
...
function r_(e, t, n) {
	...
	for (let e of t.values()) Fh(i, jh(e)) > 0 && r.push(e);
	return r;
}
var i_ = 250;
function a_(e, t, n, r) {
	let i = [], a = Infinity, o = r_(e, n, t + i_);
	for (let n of o) {
		...
		for (let s of o) {
			...
			let { x: o, y: c } = kg(n, s, s.position, !0), l = Math.sqrt((o - e.x) ** 2 + (c - e.y) ** 2);
			l > t || (l < a ? (i = [{
				...s,
				x: o,
				y: c
...
var l_ = () => !0;
function u_(e, { connectionMode: t, connectionRadius: n, handleId: r, nodeId: i, edgeUpdaterType: a, isTarget: o, domNode: s, nodeLookup: c, lib: l, autoPanOnConnect: u, flowId: d, panBy: f, cancelConnection: p, onConnectStart: m, onConnect: h, onConnectEnd: g, isValidConnection: _ = l_, onReconnectEnd: v, updateConnection: y, getTransform: b, getFromHandle: x, autoPanSpeed: S, dragThreshold: C = 1, handleDomNode: w }) {
	let T = rg(e.target), E = 0, D, { x: O, y: k } = sg(e), A = s_(a, w), j = s?.getBoundingClientRect(), ee = !1;
	if (!j || !A) return;
	let M = o_(i, A, r, c, t);
	if (!M) return;
	let te = sg(e, j), ne = !1, re = null, ie = !1, ae = null;
	function oe() {
		if (!u || !j) return;
		let [e, t] = Dh(te, j, S);
		f({
	...
	let se = {
		...
		inProgress: !0,
		isValid: null,
		from: kg(ce, se, lh.Left, !0),
		fromHandle: se,
		fromPosition: se.position,
		fromNode: ce,
		to: te,
		toHandle: null,
		toPosition: uh[se.position],
		toNode: null,
		pointer: te
	};
	function ue() {
	...
	function de(e) {
		...
		let a = b();
		te = sg(e, j), D = a_(Bh(te, a, !1, [1, 1]), n, c, se), ne ||= (oe(), !0);
		let s = d_(e, {
			handle: D,
			connectionMode: t,
			fromNodeId: i,
		...
		ae = s.handleDomNode, re = s.connection, ie = c_(!!D, s.isValid);
		let u = c.get(i), f = u ? kg(u, se, lh.Left, !0) : le.from, p = {
			...le,
			from: f,
			isValid: ie,
			to: s.toHandle && ie ? Vh({
			...
			toHandle: s.toHandle,
			toPosition: ie && s.toHandle ? s.toHandle.position : uh[se.position],
...
function d_(e, { handle: t, connectionMode: n, fromNodeId: r, fromHandleId: i, fromType: a, doc: o, lib: s, flowId: c, isValidConnection: l = l_, nodeLookup: u }) {
	let d = a === "target", f = t ? o.querySelector(`.${s}-flow__handle[data-id="${c}-${t?.nodeId}-${t?.id}-${t?.type}"]`) : null, { x: p, y: m } = sg(e), h = o.elementFromPoint(p, m), g = h?.classList.contains(`${s}-flow__handle`) ? h : f, _ = {
		handleDomNode: g,
		isValid: !1,
		connection: null,
		toHandle: null
	...
	if (g) {
		let e = s_(void 0, g), t = g.getAttribute("data-nodeid"), a = g.getAttribute("data-handleid"), o = g.classList.contains("connectable"), s = g.classList.contains("connectableend");
		if (!t || !e) return _;
		let c = {
			source: d ? t : r,
			sourceHandle: d ? a : i,
		...
		_.connection = c, _.isValid = o && s && (n === rh.Strict ? d && e === "source" || !d && e === "target" : t !== r || a !== i) && l(c), _.toHandle = o_(t, e, a, u, n, !0);
	}
	return _;
}
var f_ = {
...
function p_({ domNode: e, panZoom: t, getTransform: n, getViewScale: r }) {
	let i = bd(e);
	function a({ translateExtent: e, width: a, height: o, zoomStep: s = 1, pannable: c = !0, zoomable: l = !0, inversePan: u = !1 }) {
		let d = (e) => {
			...
			let r = n(), i = e.sourceEvent.ctrlKey && Kh() ? 10 : 1, a = -e.sourceEvent.deltaY * (e.sourceEvent.deltaMode === 1 ? .05 : e.sourceEvent.deltaMode ? 1 : .002) * s, o = r[2] * 2 ** (a * i);
			t.scaleTo(o);
		}, f = [0, 0], p = Qm().on("start", (e) => {
...
var m_ = (e) => ({
	...
	y: e.y,
	zoom: e.k
}), h_ = ({ x: e, y: t, zoom: n }) => Hm.translate(e, t).scale(n), g_ = (e, t) => e.target.closest(`.${t}`), __ = (e, t) => t === 2 && Array.isArray(e) && e.includes(2), v_ = (e) => ((e *= 2) <= 1 ? e * e * e : (e -= 2) * e * e + 2) / 2, y_ = (e, t = 0, n = v_, r = () => {}) => {
	let i = typeof t == "number" && t > 0;
	return i || r(), i ? e.transition().duration(t).ease(n).on("end", r) : e;
}, b_ = (e) => {
	let t = e.ctrlKey && Kh() ? 10 : 1;
	return -e.deltaY * (e.deltaMode === 1 ? .05 : e.deltaMode ? 1 : .002) * t;
};
function x_({ zoomPanValues: e, noWheelClassName: t, d3Selection: n, d3Zoom: r, panOnScrollMode: i, panOnScrollSpeed: a, zoomOnPinch: o, onPanZoomStart: s, onPanZoom: c, onPanZoomEnd: l }) {
	return (u) => {
		if (g_(u, t)) return u.ctrlKey && u.preventDefault(), !1;
		u.preventDefault(), u.stopImmediatePropagation();
		let d = n.property("__zoom").k || 1;
		if (u.ctrlKey && o) {
			let e = Sd(u), t = d * 2 ** b_(u);
			r.scaleTo(n, t, e, u);
			return;
		}
		let f = u.deltaMode === 1 ? 20 : 1, p = i === ih.Vertical ? 0 : u.deltaX * f, m = i === ih.Horizontal ? 0 : u.deltaY * f;
		!Kh() && u.shiftKey && i !== ih.Vertical && (p = u.deltaY * f, m = 0), r.translateBy(n, -(p / d) * a, -(m / d) * a, { internal: !0 });
		let h = m_(n.property("__zoom"));
...
function S_({ noWheelClassName: e, preventScrolling: t, d3ZoomHandler: n }) {
	return function(r, i) {
		let a = r.type === "wheel", o = !t && a && !r.ctrlKey, s = g_(r, e);
		if (r.ctrlKey && a && s && r.preventDefault(), o || s) return null;
		r.preventDefault(), n.call(this, r, i);
	};
}
function C_({ zoomPanValues: e, onDraggingChange: t, onPanZoomStart: n }) {
	return (r) => {
		if (r.sourceEvent?.internal) return;
		let i = m_(r.transform);
...
function w_({ zoomPanValues: e, panOnDrag: t, onPaneContextMenu: n, onTransformChange: r, onPanZoom: i }) {
	return (a) => {
		e.usedRightMouseButton = !!(n && __(t, e.mouseButton ?? 0)), a.sourceEvent?.sync || r([
			a.transform.x,
			a.transform.y,
			a.transform.k
		]), i && !a.sourceEvent?.internal && i?.(a.sourceEvent, m_(a.transform));
	};
}
function T_({ zoomPanValues: e, panOnDrag: t, panOnScroll: n, onDraggingChange: r, onPanZoomEnd: i, onPaneContextMenu: a }) {
	return (o) => {
		if (!o.sourceEvent?.internal && (e.isZoomingOrPanning = !1, a && __(t, e.mouseButton ?? 0) && !e.usedRightMouseButton && o.sourceEvent && a(o.sourceEvent), e.usedRightMouseButton = !1, r(!1), i)) {
			let t = m_(o.transform);
...
function E_({ panActivationKeyPressed: e, zoomActivationKeyPressed: t, zoomOnScroll: n, zoomOnPinch: r, panOnDrag: i, panOnScroll: a, zoomOnDoubleClick: o, userSelectionActive: s, noWheelClassName: c, noPanClassName: l, lib: u, connectionInProgress: d }) {
	return (f) => {
		let p = t || n, m = r && f.ctrlKey, h = f.type === "wheel";
		if (f.button === 1 && f.type === "mousedown" && (g_(f, `${u}-flow__node`) || g_(f, `${u}-flow__edge`) || g_(f, `${u}-flow__selection`) || g_(f, `${u}-flow__nodesselection`))) return !0;
		if (!i && !p && !a && !o && !r || s || d && !h || g_(f, c) && h || g_(f, l) && (!h || a && h && !t) || !r && f.ctrlKey && h) return !1;
...
function D_({ domNode: e, minZoom: t, maxZoom: n, translateExtent: r, viewport: i, onPanZoom: a, onPanZoomStart: o, onPanZoomEnd: s, onDraggingChange: c }) {
	let l = {
	...
	let f = Qm().extent(() => d).scaleExtent([t, n]).translateExtent(r), p = bd(e).call(f);
	y({
		x: i.x,
		y: i.y,
		zoom: Ch(i.zoom, t, n)
	...
	async function g(e, t) {
		return p ? new Promise((n) => {
			f?.interpolate(t?.interpolate === "linear" ? zf : $f).transform(y_(p, t?.duration, t?.ease, () => n(!0)), e);
		}) : !1;
	}
	function _({ noWheelClassName: e, noPanClassName: t, onPaneContextMenu: n, userSelectionActive: r, panOnScroll: i, panOnDrag: u, panOnScrollMode: d, panOnScrollSpeed: g, preventScrolling: _, zoomOnPinch: y, zoomOnScroll: b, zoomOnDoubleClick: x, panActivationKeyPressed: S = !1, zoomActivationKeyPressed: C, lib: w, onTransformChange: T, connectionInProgress: E, paneClickDistance: D, selectionOnDrag: O }) {
		...
		let k = i && !C && !r;
		f.clickDistance(O ? Infinity : !Lh(D) || D < 0 ? 0 : D);
		let A = k ? x_({
			zoomPanValues: l,
			noWheelClassName: e,
			d3Selection: p,
	...
	async function y(e, t, n) {
		let r = h_(e), i = f?.constrain()(r, t, n);
	...
	function x(e) {
		if (p) {
			let t = h_(e), n = p.property("__zoom");
	...
	async function C(e, t) {
		return p ? new Promise((n) => {
			f?.interpolate(t?.interpolate === "linear" ? zf : $f).scaleTo(y_(p, t?.duration, t?.ease, () => n(!0)), e);
		}) : !1;
	}
	async function w(e, t) {
		return p ? new Promise((n) => {
			f?.interpolate(t?.interpolate === "linear" ? zf : $f).scaleBy(y_(p, t?.duration, t?.ease, () => n(!0)), e);
		}) : !1;
	}
	function T(e) {
		f?.scaleExtent(e);
...
var k_ = Rh("Svelte Flow", "https://svelteflow.dev/");
function A_(e, t, n = {}) {
	return vg(e, t, {
		...n,
		onError: n.onError ?? k_
	});
}
//#endregion
...
var [M_, N_] = j_(), [P_, F_] = j_(), [I_, L_] = j_(), R_ = /* @__PURE__ */ new Set([
	"$$slots",
	"$$events",
	"$$legacy",
	"id",
	...
	"ondisconnect",
	"children"
]), z_ = /* @__PURE__ */ G("<div><!></div>");
function B_(e, t) {
	bt(t, !0);
	let n = Q(t, "id", 3, null), r = Q(t, "type", 3, "source"), i = Q(t, "position", 19, () => lh.Top), a = Q(t, "isConnectableStart", 3, !0), o = Q(t, "isConnectableEnd", 3, !0), s = /* @__PURE__ */ xo(t, R_), c = M_("Handle must be used within a Custom Node component"), l = P_("Handle must be used within a Custom Node component"), d = /* @__PURE__ */ P(() => r() === "target"), f = /* @__PURE__ */ P(() => t.isConnectable === void 0 ? l.value : t.isConnectable), p = wv(), m = /* @__PURE__ */ P(() => p.ariaLabelConfig), h = null;
	Ir(() => {
		if (t.onconnect || t.ondisconnect) {
			...
			if (h && !Qh(e, h)) {
				...
				$h(h, n, t.ondisconnect), $h(n, h, t.onconnect);
			}
			h = new Map(e);
		}
	});
	let g = /* @__PURE__ */ P(() => {
		...
		return [
			...
			a,
			o,
			p.connectionMode === rh.Strict ? e?.type !== r() : c !== e?.nodeId || n() !== e?.id,
			o && i
		];
	...
	function T(e) {
		let r = og(e);
		e.currentTarget && (r && e.button === 0 || !r) && f_.onPointerDown(e, {
			handleId: n(),
			nodeId: c,
			isTarget: H(d),
	...
	function E(e) {
		...
		let i = rg(e.target), o = t.isValidConnection ?? p.isValidConnection, { connectionMode: s, clickConnectStartHandle: l, flowId: u, nodeLookup: d } = p, { connection: f, isValid: m } = f_.isValid(e, {
			handle: {
				nodeId: c,
				id: n(),
				type: r()
...
function H_(e, t) {
	bt(t, !0);
	let n = Q(t, "targetPosition", 19, () => lh.Top), r = Q(t, "sourcePosition", 19, () => lh.Bottom);
	var i = V_(), a = R(i);
	B_(a, {
		type: "target",
		get position() {
...
function W_(e, t) {
	bt(t, !0);
	let n = Q(t, "data", 19, () => ({ label: "Node" })), r = Q(t, "sourcePosition", 19, () => lh.Bottom);
	Ke();
	var i = U_(), a = R(i);
	B_(z(a), {
		type: "source",
...
function K_(e, t) {
	bt(t, !0);
	let n = Q(t, "data", 19, () => ({ label: "Node" })), r = Q(t, "targetPosition", 19, () => lh.Top);
	Ke();
	var i = G_(), a = R(i);
	B_(z(a), {
		type: "target",
...
function Y_(e, t) {
	let n = /* @__PURE__ */ P(wv), r = /* @__PURE__ */ P(() => H(n).domNode), i;
	return H(r) ? J_(e, H(r), t) : i = Lr(() => {
		Pr(() => {
			J_(e, H(r), t), i?.();
		});
	}), {
...
var ev = {
	...
	"class",
	"children"
]), nv = /* @__PURE__ */ G("<div><!></div>");
function rv(e, t) {
	bt(t, !0);
	let n = Q(t, "x", 3, 0), r = Q(t, "y", 3, 0), i = Q(t, "selectEdgeOnClick", 3, !1), a = Q(t, "transparent", 3, !1), o = /* @__PURE__ */ xo(t, tv), s = wv(), c = I_("EdgeLabel must be used within a Custom Edge component"), l = /* @__PURE__ */ P(() => s.visible.edges.get(c)?.zIndex);
	var u = nv(), d = () => {
	...
	ro(u, (e) => ({
		...
		height: $_(t.height),
		"z-index": H(l)
	})], void 0, void 0, "svelte-1wg91mu"), Ea(L(u), () => t.children ?? C), N(u), Oa(u, (e, t) => Y_?.(e, t), () => "edge-labels"), K(e, u), xt();
}
//#endregion
...
var iv = /* @__PURE__ */ new Set([
	...
	"interactionWidth",
	"class"
]), av = /* @__PURE__ */ oa("<path></path>"), ov = /* @__PURE__ */ oa("<path fill=\"none\"></path><!><!>", 1);
function sv(e, t) {
	let n = Q(t, "interactionWidth", 3, 20), r = /* @__PURE__ */ xo(t, iv);
	var i = ov(), a = R(i), o = z(a), s = (e) => {
		var i = av();
		ro(i, () => ({
			d: t.path,
			"stroke-opacity": 0,
...
var fv = class {
	...
	constructor(e, t) {
		let n = pv.test(e) || e.split(/[\s,]+/).some((e) => mv.has(e.trim())) ? e : `(${e})`, r = window.matchMedia(n);
...
var vv = Rh("Svelte Flow", "https://svelteflow.dev/"), yv = {
	input: W_,
	output: K_,
	default: H_,
	group: q_
...
function xv(e, t, n, r, i, a) {
	return t && !n && r && i ? Gh(gh(a, { filter: (e) => !!((e.width || e.initialWidth) && (e.height || e.initialHeight)) }), r, i, .5, 2, .1) : n ?? {
		x: 0,
		y: 0,
		zoom: 1
	};
...
function Sv(e) {
	class t {
		...
		#o = /* @__PURE__ */ P(() => {
			let { nodesInitialized: t } = Vg(e.nodes, this.nodeLookup, this.parentLookup, {
		...
		#c = /* @__PURE__ */ P(() => (Xg(this.connectionLookup, this.edgeLookup, e.edges), e.edges));
		get _edges() {
			return H(this.#c);
		}
		set _edges(e) {
		...
		#x = /* @__PURE__ */ P(() => e.props.nodeExtent ?? eh);
		get nodeExtent() {
			return H(this.#x);
		}
		set nodeExtent(e) {
		...
		#S = /* @__PURE__ */ P(() => e.props.translateExtent ?? eh);
		get translateExtent() {
			return H(this.#S);
		}
		...
		#B = /* @__PURE__ */ P(() => e.props.selectionMode ?? ah.Partial);
		get selectionMode() {
			return H(this.#B);
		}
		set selectionMode(e) {
		...
		#K = /* @__PURE__ */ P(() => Zh(e.props.ariaLabelConfig));
		get ariaLabelConfig() {
			return H(this.#K);
		}
		...
		#q = /* @__PURE__ */ tr(xv(this.nodesInitialized, e.props.fitView, e.props.initialViewport, this.width, this.height, this.nodeLookup));
		get _viewport() {
			return H(this.#q);
		}
		set _viewport(e) {
		...
		#X = /* @__PURE__ */ P(() => e.props.connectionMode ?? rh.Strict);
		get connectionMode() {
			return H(this.#X);
		}
		...
		#re = /* @__PURE__ */ P(() => e.props.onflowerror ?? vv);
		get onerror() {
			return H(this.#re);
		}
		set onerror(e) {
		...
		_prefersDark = new hv("(prefers-color-scheme: dark)", e.props.colorModeSSR === "dark");
		...
		constructor() {}
		resetStoreValues() {
			this.dragging = !1, this.selectionRect = null, this.selectionRectMode = null, this.selectionKeyPressed = !1, this.multiselectionKeyPressed = !1, this.deleteKeyPressed = !1, this.panActivationKeyPressed = !1, this.zoomActivationKeyPressed = !1, this._connection = oh, this.clickConnectStartHandle = null, this.viewport = e.props.initialViewport ?? {
				x: 0,
				y: 0,
				zoom: 1
...
function Ev(e) {
	...
	function i(e) {
		t.edges = A_(e, t.edges, { onError: t.onerror });
	}
	let a = (e, n = !1) => {
		t.nodes = t.nodes.map((r) => {
			if (t.connection.inProgress && t.connection.fromNode.id === r.id) {
				...
				e && (t.connection = {
					...t.connection,
					from: kg(e, t.connection.fromHandle, lh.Left, !0)
				});
			}
			let i = e.get(r.id);
			return i ? {
	...
	function o(e) {
		let { changes: n, updatedInternals: r } = qg(e, t.nodeLookup, t.parentLookup, t.domNode, t.nodeOrigin, t.nodeExtent, t.zIndexMode);
		if (!r) return;
	...
	function x(e, n) {
		...
		for (let e of s.values()) {
			...
			i && (t = zh(t, i));
			let { position: n, positionAbsolute: a } = xh({
				nodeId: e.id,
				nextPosition: t,
				nodeLookup: s,
				nodeExtent: r,
...
function Dv(e, t) {
	let { minZoom: n, maxZoom: r, initialViewport: i, onPanZoomStart: a, onPanZoom: o, onPanZoomEnd: s, translateExtent: c, setPanZoomInstance: l, onDraggingChange: u, onTransformChange: d } = t, f = D_({
		domNode: e,
		minZoom: n,
		maxZoom: r,
		translateExtent: c,
...
var Ov = /* @__PURE__ */ G("<div class=\"svelte-flow__zoom svelte-flow__container\"><!></div>");
function kv(e, t) {
	bt(t, !0);
	...
	var s = Ov();
	Ea(L(s), () => t.children), N(s), Oa(s, (e, t) => Dv?.(e, t), () => ({
		viewport: n().viewport,
		minZoom: n().minZoom,
		maxZoom: n().maxZoom,
		initialViewport: a,
...
function Pv(e, t) {
	...
	function y(e, t) {
		...
		l = new Set(_h(n().nodeLookup, a, [
			n().viewport.x,
			n().viewport.y,
			n().viewport.zoom
		], n().selectionMode === ah.Partial, !0).map((e) => e.id));
		...
		Mv(o, l) || n(n().nodes = n().nodes.map(jv(l)), !0), Mv(s, u) || n(n().edges = n().edges.map(jv(u)), !0), n(n().selectionRectMode = "user", !0), n(n().selectionRect = a, !0);
	}
	function b() {
		if (!a() || !s) return;
		let [e, t] = Dh(g, s, n().autoPanSpeed);
		n().panBy({
			x: e,
			y: t
		}).then((e) => {
	...
	var O = Nv();
	let k;
	var A = /* @__PURE__ */ P(() => H(p) ? void 0 : Av(D, o)), j = /* @__PURE__ */ P(() => Av(T, o));
...
var Fv = /* @__PURE__ */ G("<div class=\"svelte-flow__viewport xyflow__viewport svelte-flow__container\"><!></div>");
function Iv(e, t) {
	bt(t, !0);
	var n = Fv();
	let r;
...
function Lv(e, t) {
	let { store: n, onDrag: r, onDragStart: i, onDragStop: a, onNodeMouseDown: o } = t, s = n_({
		onDrag: r,
		onDragStart: i,
		onDragStop: a,
		onNodeMouseDown: o,
...
var Rv = /* @__PURE__ */ G("<div aria-live=\"assertive\" aria-atomic=\"true\" class=\"a11y-live-msg svelte-13pq11u\"> </div>"), zv = /* @__PURE__ */ G("<div class=\"a11y-hidden svelte-13pq11u\"> </div> <div class=\"a11y-hidden svelte-13pq11u\"> </div> <!>", 1);
function Bv(e, t) {
	bt(t, !0);
	var n = zv(), r = R(n), i = L(r, !0);
	N(r);
	var a = z(r, 2), o = L(a, !0);
	N(a);
	var s = z(a, 2), c = (e) => {
		var n = Rv(), r = L(n, !0);
		N(n), V(() => {
			Z(n, "id", `${Uv}-${t.store.flowId}`), q(r, t.store.ariaLiveMessage);
		}), K(e, n);
	};
	J(s, (e) => {
		t.store.disableKeyboardA11y || e(c);
	}), V(() => {
		Z(r, "id", `${Vv}-${t.store.flowId}`), q(i, t.store.disableKeyboardA11y ? t.store.ariaLabelConfig["node.a11yDescription.default"] : t.store.ariaLabelConfig["node.a11yDescription.keyboardDisabled"]), Z(a, "id", `${Hv}-${t.store.flowId}`), q(o, t.store.ariaLabelConfig["edge.a11yDescription.default"]);
	}), K(e, n), xt();
}
//#endregion
//#region node_modules/@xyflow/svelte/dist/lib/components/A11yDescriptions/index.js
var Vv = "svelte-flow__node-desc", Hv = "svelte-flow__edge-desc", Uv = "svelte-flow__aria-live", Wv = /* @__PURE__ */ G("<div><!></div>");
function Gv(e, t) {
	bt(t, !0);
	let n = Q(t, "store", 15), r = /* @__PURE__ */ P(() => l(t.node.data, () => ({}), !0)), i = /* @__PURE__ */ P(() => l(t.node.selected, !1)), a = /* @__PURE__ */ P(() => t.node.draggable), o = /* @__PURE__ */ P(() => t.node.selectable), s = /* @__PURE__ */ P(() => l(t.node.deletable, !0)), c = /* @__PURE__ */ P(() => t.node.connectable), u = /* @__PURE__ */ P(() => t.node.focusable), d = /* @__PURE__ */ P(() => l(t.node.hidden, !1)), f = /* @__PURE__ */ P(() => l(t.node.dragging, !1)), p = /* @__PURE__ */ P(() => l(t.node.style, "")), m = /* @__PURE__ */ P(() => t.node.class), h = /* @__PURE__ */ P(() => l(t.node.type, "default")), g = /* @__PURE__ */ P(() => t.node.parentId), _ = /* @__PURE__ */ P(() => t.node.sourcePosition), v = /* @__PURE__ */ P(() => t.node.targetPosition), y = /* @__PURE__ */ P(() => l(t.node.measured, () => ({
		...
		width: 0,
		height: 0
	}), !0).height), x = /* @__PURE__ */ P(() => t.node.initialWidth), S = /* @__PURE__ */ P(() => t.node.initialHeight), C = /* @__PURE__ */ P(() => t.node.width), w = /* @__PURE__ */ P(() => t.node.height), T = /* @__PURE__ */ P(() => t.node.dragHandle), E = /* @__PURE__ */ P(() => l(t.node.internals.z, 0)), D = /* @__PURE__ */ P(() => t.node.internals.positionAbsolute.x), O = /* @__PURE__ */ P(() => t.node.internals.positionAbsolute.y), k = /* @__PURE__ */ P(() => t.node.internals.userNode), { id: A } = t.node, j = /* @__PURE__ */ P(() => H(a) ?? n().nodesDraggable), ee = /* @__PURE__ */ P(() => H(o) ?? n().elementsSelectable), M = /* @__PURE__ */ P(() => H(c) ?? n().nodesConnectable), te = /* @__PURE__ */ P(() => Yh(t.node)), ne = /* @__PURE__ */ P(() => !!t.node.internals.handleBounds), re = /* @__PURE__ */ P(() => H(te) && H(ne)), ie = /* @__PURE__ */ P(() => H(u) ?? n().nodesFocusable);
	function ae(e) {
		return n().parentLookup.has(e);
	}
	let oe = /* @__PURE__ */ P(() => ae(A)), se = /* @__PURE__ */ tr(null), ce = null, le = H(h), ue = H(_), de = H(v), fe = /* @__PURE__ */ P(() => n().nodeTypes[H(h)] ?? H_), pe = /* @__PURE__ */ P(() => n().ariaLabelConfig);
	N_(A), F_({ get value() {
		return H(M);
	} });
	let me = /* @__PURE__ */ P(() => {
		let e = H(y) === void 0 ? H(C) ?? H(x) : H(C), t = H(b) === void 0 ? H(w) ?? H(S) : H(w);
		if (e !== void 0 || t !== void 0 || H(p) !== void 0) return `${H(p)};${e ? `width:${$_(e)};` : ""}${t ? `height:${$_(t)};` : ""}`;
	});
	Pr(() => {
	...
	function ge(e) {
		if (!(ag(e) || n().disableKeyboardA11y)) {
			if (th.includes(e.key) && H(ee)) {
				let t = e.key === "Escape";
				n().handleNodeSelection(A, t, H(se));
			} else H(j) && t.node.selected && Object.prototype.hasOwnProperty.call(ev, e.key) && (e.preventDefault(), n(n().ariaLiveMessage = H(pe)["node.a11yDescription.ariaLiveMessage"]({
				direction: e.key.replace("Arrow", "").toLowerCase(),
				x: ~~t.node.internals.positionAbsolute.x,
				y: ~~t.node.internals.positionAbsolute.y
			}), !0), n().moveSelectedNodes(ev[e.key], e.shiftKey ? 4 : 1));
		}
	}
	let _e = () => {
		if (n().disableKeyboardA11y || !n().autoPanOnNodeFocus || !H(se)?.matches(":focus-visible")) return;
		let { width: e, height: r, viewport: i } = n();
		_h(/* @__PURE__ */ new Map([[A, t.node]]), {
			x: 0,
			y: 0,
			width: e,
			height: r
	...
	var ve = ca(), ye = R(ve), be = (e) => {
		...
		ro(a, () => ({
			...
			"aria-describedby": n().disableKeyboardA11y ? void 0 : `${Vv}-${n().flowId}`,
...
var Kv = /* @__PURE__ */ G("<div class=\"svelte-flow__nodes\"></div>");
function qv(e, t) {
	bt(t, !0);
...
var Jv = /* @__PURE__ */ oa("<svg class=\"svelte-flow__edge-wrapper\"><g><!></g></svg>");
function Yv(e, t) {
	bt(t, !0);
	...
	L_(H(n));
	let j = null, ee = /* @__PURE__ */ P(() => H(w) ?? t.store.elementsSelectable), M = /* @__PURE__ */ P(() => H(T) ?? t.store.edgesFocusable), te = /* @__PURE__ */ P(() => t.store.edgeTypes[H(y)] ?? cv), ne = /* @__PURE__ */ P(() => H(S) ? `url('#${jg(H(S), t.store.flowId)}')` : void 0), re = /* @__PURE__ */ P(() => H(C) ? `url('#${jg(H(C), t.store.flowId)}')` : void 0);
	function ie(e) {
	...
	function oe(e) {
		if (!t.store.disableKeyboardA11y && th.includes(e.key) && H(ee)) {
	...
	var se = ca(), ce = R(se), le = (e) => {
		...
		ro(C, () => ({
			...
			"aria-describedby": H(M) ? `${Hv}-${t.store.flowId}` : void 0,
...
var Qv = /* @__PURE__ */ oa("<polyline class=\"arrow\" fill=\"none\" stroke-linecap=\"round\" stroke-linejoin=\"round\" points=\"-5,-4 0,0 -5,4\"></polyline>"), $v = /* @__PURE__ */ oa("<polyline class=\"arrowclosed\" stroke-linecap=\"round\" stroke-linejoin=\"round\" points=\"-5,-4 0,0 -5,4 -5,-4\"></polyline>"), ey = /* @__PURE__ */ oa("<marker class=\"svelte-flow__arrowhead\" viewBox=\"-10 -10 20 20\" refX=\"0\" refY=\"0\"><!></marker>");
function ty(e, t) {
	bt(t, !0);
	...
	J(c, (e) => {
		t.type === ch.Arrow ? e(l) : t.type === ch.ArrowClosed && e(u, 1);
	}), N(s), V(() => {
...
var ny = /* @__PURE__ */ G("<div class=\"svelte-flow__edges\"><svg class=\"svelte-flow__marker\"><!></svg> <!></div>");
function ry(e, t) {
	bt(t, !0);
	let n = Q(t, "store", 15);
	var r = ny(), i = L(r);
	Zv(L(i), {}), N(i), Y(z(i, 2), 17, () => n().visible.edges.values(), (e) => e.id, (e, r) => {
		Yv(e, {
			get edge() {
				return H(r);
			},
...
var iy = /* @__PURE__ */ G("<div class=\"svelte-flow__selection svelte-1vr3gfi\"></div>");
function ay(e, t) {
	bt(t, !0);
	...
	var s = ca(), c = R(s), l = (e) => {
		...
		let o;
		V((e) => o = za(t, "", o, e), [() => ({
			width: typeof i() == "string" ? i() : $_(i()),
			height: typeof a() == "string" ? a() : $_(a()),
...
function sy(e, t) {
	...
	let r = /* @__PURE__ */ P(() => {
		if (t.store.selectionRectMode === "nodes") {
			t.store.nodes;
			let e = gh(t.store.nodeLookup, { filter: (e) => !!e.selected });
	...
	function o(e) {
		Object.prototype.hasOwnProperty.call(ev, e.key) && (e.preventDefault(), t.store.moveSelectedNodes(ev[e.key], e.shiftKey ? 4 : 1));
	}
	var s = ca(), c = R(s), l = (e) => {
		var s = oy();
		let c;
	...
	}, u = /* @__PURE__ */ P(() => t.store.selectionRectMode === "nodes" && H(r) && Lh(H(r).x) && Lh(H(r).y));
	J(c, (e) => {
		H(u) && e(l);
	}), K(e, s), xt();
}
		...
		for (let r of n) {
			...
			if (!o && !s && console.warn("[svelte-put/shortcut] Trigger should have either `key` or `code`, a trigger missing both was detected! Check your configuration"), u && (o || s)) {
				...
				if (a === null || a === !1) {
					...
					for (let n of e) if ((Array.isArray(n) ? n : [n]).reduce((e, t) => e | cy(t), 0) === i) {
						t = !0;
						break;
					}
					if (!t) continue;
...
function uy() {
	let e = /* @__PURE__ */ P(wv), t = (t) => {
		let n = Z_(t) ? t : H(e).nodeLookup.get(t.id), r = n.parentId ? Xh(n.position, n.measured, n.parentId, H(e).nodeLookup, H(e).nodeOrigin) : n.position;
		return jh({
			...n,
			position: r,
	...
	return {
		...
		getNodes: (t) => t === void 0 ? H(e).nodes : dy(H(e).nodeLookup, t),
		getEdge: (t) => H(e).edgeLookup.get(t),
		getEdges: (t) => t === void 0 ? H(e).edges : dy(H(e).edgeLookup, t),
		setZoom: async (t, n) => {
			let r = H(e).panZoom;
		...
		fitBounds: async (t, n) => {
			...
			let r = Gh(t, H(e).width, H(e).height, H(e).minZoom, H(e).maxZoom, n?.padding ?? .1);
		...
		flowToScreenPosition: (t) => {
			if (!H(e).domNode) return t;
			let { x: n, y: r, zoom: i } = H(e).viewport, { x: a, y: o } = H(e).domNode.getBoundingClientRect(), s = Vh(t, [
				n,
				r,
				i
			]);
...
function fy(e, t) {
	bt(t, !0);
	let n = Q(t, "store", 15), r = Q(t, "selectionKey", 3, "Shift"), i = Q(t, "multiSelectionKey", 19, () => Kh() ? "Meta" : "Control"), a = Q(t, "deleteKey", 3, "Backspace"), o = Q(t, "panActivationKey", 3, " "), s = Q(t, "zoomActivationKey", 19, () => Kh() ? "Meta" : "Control"), { deleteElements: c } = uy();
	function l(e) {
	...
	Xi("blur", Cr, p), Xi("contextmenu", Cr, p), Oa(Cr, (e, t) => ly?.(e, t), () => ({
		...
		trigger: f(a(), (e) => {
			!(e.originalEvent.ctrlKey || e.originalEvent.metaKey || e.originalEvent.shiftKey) && !ag(e.originalEvent) && (n(n().deleteKeyPressed = !0, !0), m());
		}),
		type: "keydown"
	})), Oa(Cr, (e, t) => ly?.(e, t), () => ({
...
var py = /* @__PURE__ */ oa("<path fill=\"none\" class=\"svelte-flow__connection-path\"></path>"), my = /* @__PURE__ */ oa("<svg class=\"svelte-flow__connectionline\"><g><!></g></svg>");
function hy(e, t) {
	bt(t, !0);
	let n = /* @__PURE__ */ P(() => {
		...
		switch (t.type) {
			...
			case sh.SmoothStep: {
				let [n] = Tg({
					...e,
					borderRadius: t.type === sh.Step ? 0 : void 0
				});
				return n;
			}
		}
	...
	var r = ca(), i = R(r), a = (e) => {
		...
		}, [() => Ma(["svelte-flow__connection", eg(t.store.connection.isValid)])]), K(e, r);
	};
	J(i, (e) => {
...
var gy = /* @__PURE__ */ new Set([
	...
	"class",
	"children"
]), _y = /* @__PURE__ */ G("<div><!></div>");
function vy(e, t) {
	bt(t, !0);
	let n = Q(t, "position", 3, "top-right"), r = /* @__PURE__ */ xo(t, gy), i = /* @__PURE__ */ P(() => `${n()}`.split("-"));
	var a = _y();
	ro(a, (e) => ({
		class: e,
		style: t.style,
...
var yy = /* @__PURE__ */ G("<a target=\"_blank\" rel=\"noopener noreferrer\" aria-label=\"Svelte Flow attribution\">Svelte Flow</a>");
function by(e, t) {
	bt(t, !0);
...
var Cy = /* @__PURE__ */ new Set(/* @__PURE__ */ "$$slots.$$events.$$legacy.width.height.proOptions.selectionKey.deleteKey.panActivationKey.multiSelectionKey.zoomActivationKey.paneClickDistance.nodeClickDistance.onmovestart.onmoveend.onmove.oninit.onnodeclick.onnodecontextmenu.onnodedrag.onnodedragstart.onnodedragstop.onnodepointerenter.onnodepointermove.onnodepointerleave.onselectionclick.onselectioncontextmenu.onselectionstart.onselectionend.onedgeclick.onedgecontextmenu.onedgepointerenter.onedgepointerleave.onpaneclick.onpanecontextmenu.panOnScrollMode.preventScrolling.zoomOnScroll.zoomOnDoubleClick.zoomOnPinch.panOnScroll.panOnScrollSpeed.panOnDrag.selectionOnDrag.autoPanOnSelection.connectionLineComponent.connectionLineStyle.connectionLineContainerStyle.connectionLineType.attributionPosition.children.nodes.edges.viewport".split(".")), wy = /* @__PURE__ */ G("<div class=\"svelte-flow__viewport-back svelte-flow__container\"></div> <!> <div class=\"svelte-flow__edge-labels svelte-flow__container\"></div> <!> <!> <!> <div class=\"svelte-flow__viewport-front svelte-flow__container\"></div>", 1), Ty = /* @__PURE__ */ G("<!> <!>", 1), Ey = /* @__PURE__ */ G("<!> <!> <!> <!> <!>", 1);
function Dy(e, t) {
	bt(t, !0);
	let n = Q(t, "paneClickDistance", 3, 1), r = Q(t, "nodeClickDistance", 3, 1), i = Q(t, "panOnScrollMode", 19, () => ih.Free), a = Q(t, "preventScrolling", 3, !0), o = Q(t, "zoomOnScroll", 3, !0), s = Q(t, "zoomOnDoubleClick", 3, !0), c = Q(t, "zoomOnPinch", 3, !0), l = Q(t, "panOnScroll", 3, !1), u = Q(t, "panOnScrollSpeed", 3, .5), d = Q(t, "panOnDrag", 3, !0), f = Q(t, "selectionOnDrag", 3, !1), p = Q(t, "autoPanOnSelection", 3, !0), m = Q(t, "connectionLineType", 19, () => sh.Bezier), h = Q(t, "nodes", 31, () => ur([])), g = Q(t, "edges", 31, () => ur([])), _ = Q(t, "viewport", 15, void 0), v = /* @__PURE__ */ xo(t, Cy), y = Ev({
		props: v,
		width: t.width,
		height: t.height,
		get nodes() {
	...
	b && b.setStore && b.setStore(y), vt(Tv, {
		provider: !1,
		getStore() {
			return y;
		}
...
var Oy = /* @__PURE__ */ new Set([
	...
	"onclick",
	"children"
]), ky = /* @__PURE__ */ G("<button><!></button>");
function Ay(e, t) {
	let n = /* @__PURE__ */ xo(t, Oy);
	var r = ky();
	ro(r, () => ({
		type: "button",
		onclick: t.onclick,
...
var jy = /* @__PURE__ */ oa("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 32\"><path d=\"M32 18.133H18.133V32h-4.266V18.133H0v-4.266h13.867V0h4.266v13.867H32z\"></path></svg>");
function My(e) {
	K(e, jy());
}
//#endregion
//#region node_modules/@xyflow/svelte/dist/lib/plugins/Controls/Icons/Minus.svelte
var Ny = /* @__PURE__ */ oa("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 5\"><path d=\"M0 0h32v4.2H0z\"></path></svg>");
function Py(e) {
	K(e, Ny());
}
//#endregion
//#region node_modules/@xyflow/svelte/dist/lib/plugins/Controls/Icons/Fit.svelte
var Fy = /* @__PURE__ */ oa("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 30\"><path d=\"M3.692 4.63c0-.53.4-.938.939-.938h5.215V0H4.708C2.13 0 0 2.054 0 4.63v5.216h3.692V4.631zM27.354 0h-5.2v3.692h5.17c.53 0 .984.4.984.939v5.215H32V4.631A4.624 4.624 0 0027.354 0zm.954 24.83c0 .532-.4.94-.939.94h-5.215v3.768h5.215c2.577 0 4.631-2.13 4.631-4.707v-5.139h-3.692v5.139zm-23.677.94c-.531 0-.939-.4-.939-.94v-5.138H0v5.139c0 2.577 2.13 4.707 4.708 4.707h5.138V25.77H4.631z\"></path></svg>");
function Iy(e) {
	K(e, Fy());
}
//#endregion
//#region node_modules/@xyflow/svelte/dist/lib/plugins/Controls/Icons/Lock.svelte
var Ly = /* @__PURE__ */ oa("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 32\"><path d=\"M21.333 10.667H19.81V7.619C19.81 3.429 16.38 0 12.19 0 8 0 4.571 3.429 4.571 7.619v3.048H3.048A3.056 3.056 0 000 13.714v15.238A3.056 3.056 0 003.048 32h18.285a3.056 3.056 0 003.048-3.048V13.714a3.056 3.056 0 00-3.048-3.047zM12.19 24.533a3.056 3.056 0 01-3.047-3.047 3.056 3.056 0 013.047-3.048 3.056 3.056 0 013.048 3.048 3.056 3.056 0 01-3.048 3.047zm4.724-13.866H7.467V7.619c0-2.59 2.133-4.724 4.723-4.724 2.591 0 4.724 2.133 4.724 4.724v3.048z\"></path></svg>");
function Ry(e) {
	K(e, Ly());
}
//#endregion
//#region node_modules/@xyflow/svelte/dist/lib/plugins/Controls/Icons/Unlock.svelte
var zy = /* @__PURE__ */ oa("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 32\"><path d=\"M21.333 10.667H19.81V7.619C19.81 3.429 16.38 0 12.19 0c-4.114 1.828-1.37 2.133.305 2.438 1.676.305 4.42 2.59 4.42 5.181v3.048H3.047A3.056 3.056 0 000 13.714v15.238A3.056 3.056 0 003.048 32h18.285a3.056 3.056 0 003.048-3.048V13.714a3.056 3.056 0 00-3.048-3.047zM12.19 24.533a3.056 3.056 0 01-3.047-3.047 3.056 3.056 0 013.047-3.048 3.056 3.056 0 013.048 3.048 3.056 3.056 0 01-3.048 3.047z\"></path></svg>");
function By(e) {
	K(e, zy());
}
//#endregion
...
var Vy = /* @__PURE__ */ new Set([
	...
	"before",
	"after"
]), Hy = /* @__PURE__ */ G("<!> <!>", 1), Uy = /* @__PURE__ */ G("<!> <!> <!> <!> <!> <!>", 1);
function Wy(e, t) {
	bt(t, !0);
	let n = Q(t, "position", 3, "bottom-left"), r = Q(t, "orientation", 3, "vertical"), i = Q(t, "showZoom", 3, !0), a = Q(t, "showFitView", 3, !0), o = Q(t, "showLock", 3, !0), s = /* @__PURE__ */ xo(t, Vy), c = /* @__PURE__ */ P(wv), l = /* @__PURE__ */ P(() => ({
...
var Ky = /* @__PURE__ */ oa("<circle></circle>");
function qy(e, t) {
	var n = Ky();
	V(() => {
...
var Xy = {
	...
	[Gy.Lines]: 1,
	[Gy.Cross]: 6
}, Zy = /* @__PURE__ */ oa("<svg data-testid=\"svelte-flow__background\"><pattern patternUnits=\"userSpaceOnUse\"><!></pattern><rect x=\"0\" y=\"0\" width=\"100%\" height=\"100%\"></rect></svg>");
function Qy(e, t) {
	bt(t, !0);
	let n = Q(t, "variant", 19, () => Gy.Dots), r = Q(t, "gap", 3, 20), i = Q(t, "lineWidth", 3, 1), a = /* @__PURE__ */ P(wv), o = /* @__PURE__ */ P(() => n() === Gy.Dots), s = /* @__PURE__ */ P(() => n() === Gy.Cross), c = /* @__PURE__ */ P(() => Array.isArray(r()) ? r() : [r(), r()]), l = /* @__PURE__ */ P(() => `background-pattern-${H(a).flowId}-${t.id ?? ""}`), u = /* @__PURE__ */ P(() => [H(c)[0] * H(a).viewport.zoom || 1, H(c)[1] * H(a).viewport.zoom || 1]), d = /* @__PURE__ */ P(() => (t.size ?? Xy[n()]) * H(a).viewport.zoom), f = /* @__PURE__ */ P(() => H(s) ? [H(d), H(d)] : H(u)), p = /* @__PURE__ */ P(() => H(o) ? [H(d) / 2, H(d) / 2] : [H(f)[0] / 2, H(f)[1] / 2]);
	var m = Zy();
	let h;
	var g = L(m), _ = L(g), v = (e) => {
		{
...
function $y(e) {
	let t = /* @__PURE__ */ P(wv), n = /* @__PURE__ */ P(() => H(t).nodeLookup), r = /* @__PURE__ */ P(() => H(t).nodes), i = /* @__PURE__ */ P(() => (H(r), H(n).get(e)));
	return { get current() {
		return H(i);
	} };
}
...
var eb = /* @__PURE__ */ oa("<rect></rect>");
function tb(e, t) {
	bt(t, !0);
	let n = Q(t, "borderRadius", 3, 5), r = Q(t, "strokeWidth", 3, 2), i = /* @__PURE__ */ P(() => $y(t.id)), a = /* @__PURE__ */ P(() => {
		...
		let { width: e, height: n } = Jh(H(i).current);
		return {
			width: t.width ?? e,
			height: t.height ?? n,
...
var rb = (e) => e instanceof Function ? e : () => e, ib = /* @__PURE__ */ new Set([
	"$$slots",
	"$$events",
	"$$legacy",
	"position",
	...
	"zoomStep",
	"class"
]), ab = /* @__PURE__ */ oa("<title> </title>"), ob = /* @__PURE__ */ oa("<svg class=\"svelte-flow__minimap-svg\" role=\"img\"><!><!><path class=\"svelte-flow__minimap-mask\" fill-rule=\"evenodd\" pointer-events=\"none\"></path></svg>"), sb = /* @__PURE__ */ G("<svelte-css-wrapper style=\"display: contents\"><!></svelte-css-wrapper>", 1);
function cb(e, t) {
	bt(t, !0);
	let n = Q(t, "position", 3, "bottom-right"), r = Q(t, "nodeStrokeColor", 3, "transparent"), i = Q(t, "nodeClass", 3, ""), a = Q(t, "nodeBorderRadius", 3, 5), o = Q(t, "nodeStrokeWidth", 3, 2), s = Q(t, "width", 3, 200), c = Q(t, "height", 3, 150), l = Q(t, "pannable", 3, !0), u = Q(t, "zoomable", 3, !0), d = /* @__PURE__ */ xo(t, ib), f = /* @__PURE__ */ P(wv), p = /* @__PURE__ */ P(() => H(f).ariaLabelConfig), m = typeof window > "u" || window.chrome ? "crispEdges" : "geometricPrecision", h = /* @__PURE__ */ P(() => `svelte-flow__minimap-desc-${H(f).flowId}`), g = /* @__PURE__ */ P(() => ({
			...
			children: (e, n) => {
				var d = ca(), _ = R(d), v = (e) => {
					...
					Y(y, 17, () => H(f).nodes, (e) => e.id, (e, n) => {
						...
						var c = ca(), l = R(c), u = (e) => {
							{
								let c = /* @__PURE__ */ P(() => t.nodeColor === void 0 ? void 0 : rb(t.nodeColor)(H(n))), l = /* @__PURE__ */ P(() => rb(r())(H(n))), u = /* @__PURE__ */ P(() => rb(i())(H(n)));
								tb(e, {
									get id() {
										return H(s).id;
									},
						...
						}, d = /* @__PURE__ */ P(() => H(s) && Yh(H(s)) && !H(s).hidden);
						J(l, (e) => {
							H(d) && e(u);
						}), K(e, c);
					});
...
Ho();
var lb = /* @__PURE__ */ G("<button class=\"outline-button compact\">Load older history</button>"), ub = /* @__PURE__ */ G("<button class=\"outline-button compact\">Retry</button>"), db = /* @__PURE__ */ G("<div class=\"history-load-status\" aria-live=\"polite\"><span> </span> <!> <!></div>"), fb = /* @__PURE__ */ G("<div class=\"wave-aggregate-strip\" aria-label=\"Current multi-lane wave aggregate\"><span><b>WAVE AGGREGATE</b><strong> </strong></span> <span><b>FIXED MEMBERS</b><strong> </strong></span> <span><b>ACCOUNTED</b><strong> </strong></span> <span><b>ACTIVE</b><strong> </strong></span> <i>PROJECTION ONLY</i></div>"), pb = /* @__PURE__ */ G("<article><div><b> </b><span> </span></div> <strong> </strong> <p> </p> <small> </small></article>"), mb = /* @__PURE__ */ G("<details class=\"wave-repair-plan\" aria-label=\"Historical wave projection diagnosis\"><summary><span><b>ACCOUNTING GAP</b><strong> </strong></span> <i> </i></summary> <div class=\"wave-repair-body\"><p> </p> <!> <footer><b>NO WRITE AUTHORITY</b><span>This diagnosis cannot sync state, reconcile custody, revive a worker, dispatch a lane, or change campaign phase.</span></footer></div></details>"), hb = /* @__PURE__ */ G("<div class=\"replay-toolbar\" aria-label=\"Campaign replay controls\"><div class=\"replay-buttons\"><button aria-label=\"First milestone\">↤</button> <button aria-label=\"Previous milestone\">←</button> <button class=\"replay-play\"> </button> <button aria-label=\"Next milestone\">→</button> <button aria-label=\"Latest milestone\">↦</button></div> <label class=\"replay-scrubber\"><span> </span><input type=\"range\" min=\"0\" aria-label=\"Replay position\"/></label> <div class=\"replay-now\"><strong> </strong><span> </span></div></div>"), gb = /* @__PURE__ */ G("<button> </button>"), _b = /* @__PURE__ */ G("<div class=\"history-filters\" aria-label=\"History filters\"></div>"), vb = /* @__PURE__ */ G("<p> </p>"), yb = /* @__PURE__ */ G("<p class=\"program-history-message\">Building the durable hierarchy…</p>"), bb = /* @__PURE__ */ G("<div class=\"program-history-message error\"><span> </span><button class=\"outline-button compact\">Retry</button></div>"), xb = /* @__PURE__ */ G("<p class=\"program-history-message\">No strategy epochs have been recorded for this project.</p>"), Sb = /* @__PURE__ */ G("<p>No baseline snapshot is available for this historical epoch.</p>"), Cb = /* @__PURE__ */ G("<div class=\"boundary-row\" role=\"row\"><span><small> </small><strong> </strong></span><code> </code><code> </code></div>"), wb = /* @__PURE__ */ G("<div class=\"boundary-table\" role=\"table\" aria-label=\"Changed boundary values\"><div class=\"boundary-row heading\" role=\"row\"><span>GROUP / FIELD</span><span>START</span><span>END</span></div> <!></div>"), Tb = /* @__PURE__ */ G("<li><span><small> </small><strong> </strong></span><span><b> </b><small> </small></span></li>"), Eb = /* @__PURE__ */ G("<ol class=\"program-lanes\"></ol>"), Db = /* @__PURE__ */ G("<p>No durable research runs are attached to this wave.</p>"), Ob = /* @__PURE__ */ G("<ol class=\"program-custody\"></ol>"), kb = /* @__PURE__ */ G("<details class=\"program-wave\"><summary><span><small> </small><strong> </strong></span><span><b> </b><small> </small></span></summary> <div class=\"program-wave-body\"><!> <!></div></details>"), Ab = /* @__PURE__ */ G("<p class=\"program-history-message\">No waves are assigned to this epoch.</p>"), jb = /* @__PURE__ */ G("<details class=\"program-epoch\"><summary><span><small> </small><strong> </strong></span> <span><b> </b><small> </small></span></summary> <div class=\"program-epoch-body\"><section class=\"epoch-boundary\"><header><span><small>START / END COMPARISON</small><strong> </strong></span><b> </b></header> <!></section> <div class=\"program-waves\"><!> <!></div></div></details>"), Mb = /* @__PURE__ */ G("<div class=\"program-epochs\"></div> <footer> </footer>", 1), Nb = /* @__PURE__ */ G("<section class=\"program-history\" aria-label=\"Program history hierarchy\"><header><div><span>PROGRAM HISTORY · READ ONLY</span><strong>Epoch → wave → lane and custody</strong></div> <!></header> <!></section>"), Pb = /* @__PURE__ */ G("<i aria-hidden=\"true\"></i>"), Fb = /* @__PURE__ */ G("<button><span> </span><strong> </strong><small> </small></button> <!>", 1), Ib = /* @__PURE__ */ G("<button><span> </span><strong> </strong><small> </small></button>"), Lb = /* @__PURE__ */ G("<aside class=\"flow-inspector\"><div class=\"flow-inspector-heading\"><div><span> </span><strong> </strong></div><button aria-label=\"Close step details\">×</button></div> <p> </p> <details open=\"\"><summary>Authority boundary</summary><p>Moving through this stop requires the durable gate shown on the line. Observed files or worker activity cannot advance it.</p></details></aside>"), Rb = /* @__PURE__ */ G("<div class=\"flow-inspector empty\">Select a stop or branch to inspect what enters it and which gate controls the next move.</div>"), zb = /* @__PURE__ */ G("<div class=\"campaign-map-layout journey-layout\"><div class=\"journey-board\" aria-label=\"Linear branching campaign workflow\"><div class=\"journey-line\"></div> <div class=\"journey-branches\" aria-label=\"Supporting research branches\"></div> <footer><b> </b><span> </span></footer></div> <!></div>"), Bb = /* @__PURE__ */ G("<!> <!> <!>", 1), Vb = /* @__PURE__ */ G("<button aria-label=\"Close step details\">×</button>"), Hb = /* @__PURE__ */ G("<details open=\"\"><summary>Recorded payload</summary><pre> </pre></details>"), Ub = /* @__PURE__ */ G("<li><span> </span><strong> </strong></li>"), Wb = /* @__PURE__ */ G("<details><summary>Related substeps <strong> </strong></summary><ol></ol></details>"), Gb = /* @__PURE__ */ G("<aside class=\"flow-inspector\"><div class=\"flow-inspector-heading\"><div><span> </span><strong> </strong></div><!></div> <p> </p> <!> <!></aside>"), Kb = /* @__PURE__ */ G("<div class=\"flow-inspector empty\">Select a recorded milestone to inspect its durable payload and related substeps.</div>"), qb = /* @__PURE__ */ G("<div class=\"campaign-map-layout\"><div class=\"campaign-flow-canvas\"><!></div> <!></div>"), Jb = /* @__PURE__ */ G("<section><div class=\"campaign-map-heading\"><div><p>CAMPAIGN LINE</p><h2>One main route, with deliberate research branches</h2><span> </span></div> <div class=\"campaign-map-tabs\"><button>Workflow</button> <button>Replay</button> <button>History</button></div></div> <!> <!> <!> <!> <!> <!></section>");
function Yb(e, t) {
	bt(t, !1);
	...
	var Ne = ca(), Pe = R(Ne), Fe = (e) => {
		var t = Jb(), n = L(t), r = L(n), i = z(L(r), 2), l = L(i, !0);
		N(i), N(r);
		var u = z(r, 2), p = L(u);
		let m;
		var x = z(p, 2);
		...
		var re = z(j, 2), ie = (e) => {
			var t = fb(), n = L(t), r = z(L(n)), i = L(r, !0);
			N(r), N(n);
		...
		var oe = z(re, 2), le = (e) => {
			var t = mb(), n = L(t), r = L(n), i = z(L(r)), o = L(i);
			N(i), N(r);
			var s = z(r, 2), c = L(s, !0);
			N(s), N(n);
		...
		var ue = z(oe, 2), fe = (e) => {
			var t = hb(), n = L(t), r = L(n), i = z(r, 2), a = z(i, 2), o = L(a, !0);
			N(a);
			var s = z(a, 2), c = z(s, 2);
			N(n);
		...
		var me = z(ue, 2), he = (e) => {
			...
			var a = z(n, 2), o = (e) => {
				...
				Y(n, 7, () => (H(ae), U(() => H(ae).epochs)), (e) => e.id, (e, t, n) => {
					var r = jb(), i = L(r), a = L(i), o = L(a), s = L(o);
					N(o);
					var c = z(o), l = L(c, !0);
					N(c), N(a);
					...
					Y(k, 1, () => (H(t), U(() => H(t).waves)), (e) => e.id, (e, t) => {
						var n = kb(), r = L(n), i = L(r), a = L(i), o = L(a);
						N(a);
						var s = z(a), c = L(s, !0);
						N(s), N(i);
		...
		var ge = z(me, 2), ve = (e) => {
			...
			N(p), N(a), N(n);
			var h = z(n, 2), _ = (e) => {
				var t = Lb(), n = L(t), r = L(n), i = L(r), a = L(i, !0);
				N(i);
				var o = z(i), s = L(o, !0);
				N(o), N(r);
				var c = z(r);
					...
					Dy(e, {
						...
						children: (e, t) => {
							...
							Qy(r, {
								...
								size: 1,
								get variant() {
									return Si(Gy), U(() => Gy.Dots);
								}
							});
							var i = z(r, 2);
							Wy(i, { showLock: !1 }), cb(z(i, 2), {
								pannable: !0,
								zoomable: !0,
			...
			var r = z(n, 2), i = (e) => {
				var t = Gb(), n = L(t), r = L(n), i = L(r), a = L(i, !0);
				N(i);
				var o = z(i), s = L(o, !0);
				N(o), N(r);
				var c = z(r), l = (e) => {
				...
				var m = z(f, 2), h = (e) => {
					var t = Wb(), n = L(t), r = z(L(n)), i = L(r, !0);
					N(r), N(n);
					var a = z(n);
					Y(a, 5, () => (H(b), U(() => H(b).data.substeps)), (e) => e.id, (e, t) => {
						var n = Ub(), r = L(n), i = L(r, !0);
						N(r);
						var a = z(r), o = L(a, !0);
						N(a), N(n), V((e, t) => {
							q(i, e), q(o, t);
...
Zi(["click", "input"]), Ho();
var Xb = /* @__PURE__ */ G("<div class=\"loop-error\" role=\"alert\"><strong>Paused safely</strong><span> </span></div>"), Zb = /* @__PURE__ */ G("<p> </p>"), Qb = /* @__PURE__ */ G("<div class=\"loop-resolution\"><span> </span> <strong> </strong> <!></div>"), $b = /* @__PURE__ */ G("<div class=\"loop-resolution\"><span>REQUIRED BEFORE AUTOPILOT CAN CONTINUE</span> <strong> </strong> <p> </p></div>"), ex = /* @__PURE__ */ G("<li><b> </b><div><strong> </strong><span> </span><p> </p></div><i> </i></li>"), tx = /* @__PURE__ */ G("<li><strong> </strong><span> </span></li>"), nx = /* @__PURE__ */ G("<details class=\"schedule-deferred\"><summary>Deferred candidates <strong> </strong></summary><ul></ul></details>"), rx = /* @__PURE__ */ G("<details class=\"scheduled-wave\"><summary><span> </span><strong> </strong></summary> <div class=\"scheduled-wave-body\"><div class=\"schedule-budget\"><span><b> </b> tokens reserved</span><span><b> </b> available slots</span><span><b> </b> schedule state</span></div> <ol></ol> <!> <footer><b> </b><span> </span></footer></div></details>"), ix = /* @__PURE__ */ G("<button class=\"outline-button compact\">Stop & capture here</button>"), ax = /* @__PURE__ */ G("<button class=\"primary-button compact\">Return to custody action</button> <!>", 1), ox = /* @__PURE__ */ G("<button class=\"primary-button autopilot-start-button\" disabled=\"\">▶ Start one-loop autopilot</button> <button class=\"outline-button compact autopilot-unlock-button\"> </button>", 1), sx = /* @__PURE__ */ G("<button class=\"primary-button compact\"> </button> <!>", 1), cx = /* @__PURE__ */ G("<button class=\"primary-button compact\"> </button>"), lx = /* @__PURE__ */ G("<!> <!>", 1), ux = /* @__PURE__ */ G("<button class=\"outline-button compact\"> </button> <button class=\"outline-button compact\"> </button> <button class=\"outline-button compact\">Stop & capture here</button>", 1), dx = /* @__PURE__ */ G("<button class=\"primary-button compact\"> </button> <button class=\"outline-button compact\">Stop & capture here</button>", 1), fx = /* @__PURE__ */ G("<button class=\"primary-button\"> </button>"), px = /* @__PURE__ */ G("<div class=\"loop-boundary\"><span> </span> <strong> </strong> <small> </small></div>"), mx = /* @__PURE__ */ G("<div class=\"loop-boundary pending\"><span>END · PENDING</span><strong> </strong></div>"), hx = /* @__PURE__ */ G("<li><span> </span><div><strong> </strong><small> </small></div></li>"), gx = /* @__PURE__ */ G("<ol class=\"loop-context-steps\"></ol>"), _x = /* @__PURE__ */ G("<div role=\"status\"><span> </span></div>"), vx = /* @__PURE__ */ G("<section id=\"loop-control\" aria-live=\"polite\"><div class=\"loop-control-heading\"><div><p class=\"eyebrow\">ONE-LOOP AUTOPILOT</p> <h3> </h3> <p> </p></div> <span> </span></div> <!> <!> <!> <!> <div class=\"loop-control-row\"><div class=\"loop-now\"><span> </span> <strong> </strong></div> <div class=\"loop-buttons\"><!></div></div> <details class=\"loop-context\"><summary>Loop record & step ledger <strong> </strong></summary> <div class=\"loop-boundaries\"><div class=\"loop-boundary\"><span> </span> <strong> </strong> <small> </small></div> <!></div> <!></details> <!></section>");
function yx(e, t) {
	bt(t, !1);
	...
	var re = ca(), ie = R(re), ae = (e) => {
		var t = vx(), n = L(t), r = L(n), i = z(L(r), 2), O = L(i, !0);
		N(i);
...
Zi(["click"]), Ho();
var bx = /* @__PURE__ */ G("<div><span><small>AUTOPILOT</small><strong> </strong></span> <button type=\"button\"><i aria-hidden=\"true\"></i> </button></div>");
function xx(e, t) {
	bt(t, !1);
...
function wx(e, t) {
	...
	var m = ca(), h = R(m), g = (e) => {
		var t = Cx(), n = L(t), r = L(n), i = z(L(r)), d = L(i, !0);
		N(i), N(r);
...
function Ax(e, t) {
	...
	var b = ca(), x = R(b), S = (e) => {
		var t = kx(), n = z(L(t), 2), r = L(n);
		let i;
		Ke(4), N(n);
		var a = z(n, 2), o = (e) => {
			var t = Ex(), n = R(t), r = z(L(n), 4), i = L(r, !0);
			N(r), N(n);
			var a = z(n, 2), o = (e) => {
				var t = Tx(), n = L(t), r = L(n, !0);
			...
			var t = Dx(), n = L(t), r = z(L(n), 2), i = L(r);
			$a(i), Ke(), N(r);
			var a = z(r, 2), o = L(a, !0);
			N(a), N(n);
...
Zi(["click"]), Ho();
var jx = /* @__PURE__ */ G("<small class=\"active-lane-loading\">Loading live detail…</small>"), Mx = /* @__PURE__ */ G("<small class=\"active-lane-error\"> </small>"), Nx = /* @__PURE__ */ G("<li><b> </b><span> </span></li>"), Px = /* @__PURE__ */ G("<ul></ul>"), Fx = /* @__PURE__ */ G("<details class=\"active-lane-mini\"><summary><span class=\"active-lane-state\"><i aria-hidden=\"true\"></i><b> </b></span> <span class=\"active-lane-title\"><strong> </strong><small> </small></span> <span class=\"active-lane-glance\"><b> </b><small> </small></span></summary> <div class=\"active-lane-detail\"><p> </p> <!> <!> <div class=\"active-lane-facts\"><span><small>PROFILE</small><strong> </strong></span> <span><small>USAGE</small><strong> </strong></span> <span><small>JOB</small><strong> </strong></span></div> <!> <button class=\"outline-button compact\" type=\"button\">Open full lane inspector</button></div></details>"), Ix = /* @__PURE__ */ G("<section class=\"active-lane-strip\" aria-label=\"Currently running campaign lanes\"><header><span><i aria-hidden=\"true\"></i><small>LIVE WAVE</small><strong> </strong></span> <b>Expand a lane to inspect</b></header> <div class=\"active-lane-list\"></div></section>");
function Lx(e, t) {
	bt(t, !1);
	...
	var m = ca(), h = R(m), g = (e) => {
		var t = Ix(), n = L(t), r = L(n), i = z(L(r), 2), m = L(i);
		N(i), N(r), Ke(2), N(n);
		var h = z(n, 2);
		Y(h, 5, () => H(a), (e) => e.id, (e, t) => {
			let n = /* @__PURE__ */ Cn(() => (H(o), H(t), U(() => H(o)[H(t).id] || H(t))));
			var r = Fx(), i = L(r), a = L(i), m = z(L(a)), h = L(m, !0);
			N(m), N(a);
...
function Wx(e, t) {
	...
	var d = ca(), f = R(d), p = (e) => {
		var t = Ux(), n = L(t), r = L(n), i = L(r), a = L(i);
		N(i);
		var d = z(i, 2), f = L(d, !0);
		N(d);
		var p = z(d, 2), m = L(p, !0);
		...
		var j = z(k), ee = L(j);
		N(j), N(D);
		var M = z(D, 2), te = z(L(M)), ne = L(te, !0);
		N(te);
		var re = z(te), ie = L(re, !0);
		N(re), N(M), N(v);
		var ae = z(v, 2);
		Y(ae, 5, () => (H(o), U(() => H(o).tracks)), (e) => e.id, (e, t) => {
			var n = Rx(), r = L(n), i = L(r), a = L(i, !0);
			N(i);
			var o = z(i), s = L(o);
			N(o), N(r);
...
function Jx(e) {
	let t = e?.strategy || {}, n = t.charter || {}, r = Array.isArray(t.recentSnapshots) ? t.recentSnapshots[0] : null, i = Kx(e), a = String(e?.id || "").toLowerCase() === "cfg23" || /23[_ ]?4/i.test(String(n.question || e?.role || "")), o = qx(i, "decision-row41", "ADVANCED"), s = qx(i, "geometric-23_4-decision", "UNCHANGED");
	if (a && o) return {
	...
	return {
		objective: Gx(n.question || e?.role, "Advance the campaign's central mathematical question."),
		status: u ? "STRATEGY CHECK" : "PROGRAM COMPASS",
		headline: Gx(u?.label || n?.epoch?.objective, "Choose work by its expected knowledge delta, not its proximity to the last task."),
		changed: Gx(c?.after || c?.evidence, "No accepted frontier change is recorded for the latest wave."),
		scale: Gx(l?.after || l?.evidence, "The campaign-level consequence has not yet been recorded."),
		nextTarget: Gx(e?.wave?.synthesis?.response?.nextWave?.objective || r?.metrics?.note, "Choose a bounded move that changes a named denominator, supply measure, or decision."),
		rationale: Gx(u?.detail || n.thesis, "The portfolio should balance coverage, supply, and candidate decision."),
		antiLoop: Gx(u?.action, "Stop descendants that only repeat custody, repair, or audit work without changing a program metric."),
		moves: []
	};
}
//#endregion
...
Ho();
var Yx = /* @__PURE__ */ G("<details><summary><span><b> </b><small> </small></span><strong> </strong><i>why?</i></summary> <div><p> </p><p><b>Program payoff:</b> </p></div></details>"), Xx = /* @__PURE__ */ G("<div class=\"compass-wave\"></div>"), Zx = /* @__PURE__ */ G("<section class=\"program-compass\" aria-label=\"Program objective and recommended next research targets\"><header><div><p>PROGRAM COMPASS</p><h2> </h2></div> <strong> </strong></header> <div class=\"compass-chain\"><article><span>WIN CONDITION</span><strong> </strong></article> <i aria-hidden=\"true\">→</i> <article><span>WHAT JUST CHANGED</span><strong> </strong><small> </small></article> <i aria-hidden=\"true\">→</i> <article class=\"recommended\"><span>BEST NEXT TARGET</span><strong> </strong></article></div> <!> <details class=\"compass-reasoning\"><summary><span>WHY THIS ORDER</span><strong>Show strategy and anti-loop guard</strong></summary> <div><p> </p><p><b>Avoid the loop:</b> </p></div></details> <footer><b>ADVISORY, NOT AUTHORITY</b><span>The evidence receipts and human gates still decide what is accepted or launched.</span></footer></section>");
function Qx(e, t) {
	bt(t, !1);
	...
	var s = ca(), c = R(s), l = (e) => {
		var t = Zx(), n = L(t), r = L(n), i = z(L(r)), a = L(i, !0);
		N(i), N(r);
		var s = z(r, 2), c = L(s, !0);
		N(s), N(n);
...
function uS(e, t) {
	...
	var b = ca(), x = R(b), S = (e) => {
		...
		var j = z(k, 2), ee = L(j, !0);
		N(j), N(O), Ke(2), N(D);
		var M = z(D, 2), te = L(M), ne = L(te), re = L(ne);
		N(ne);
		var ie = z(ne), ae = L(ie);
		N(ie), N(te);
...
Zi(["click"]), Ho();
var dS = /* @__PURE__ */ G("<label class=\"svelte-1ull9g0\"><span class=\"svelte-1ull9g0\">Exact thread or turn ID</span><input maxlength=\"500\" placeholder=\"Attached coordinator reference\" class=\"svelte-1ull9g0\"/></label>"), fS = /* @__PURE__ */ G("<div class=\"strategy-review-request\"><div><span>CURRENT EPOCH</span> <strong> </strong> <p> </p></div> <label><span>Review focus</span><textarea rows=\"3\" maxlength=\"2000\"></textarea></label> <div class=\"strategy-review-provenance svelte-1ull9g0\"><label class=\"svelte-1ull9g0\"><span class=\"svelte-1ull9g0\">Review kind</span><select class=\"svelte-1ull9g0\"><option>Epoch audit</option><option>Independent idea search</option></select></label> <label class=\"svelte-1ull9g0\"><span class=\"svelte-1ull9g0\">Request source</span><select class=\"svelte-1ull9g0\"><option>Operator</option><option>Coordinator request</option></select></label> <!></div> <button class=\"primary-button\"> </button></div>"), pS = /* @__PURE__ */ G("<div class=\"strategy-review-running\"><span class=\"strategy-pulse\"></span> <div><strong> </strong><p> </p><small> </small></div></div>"), mS = /* @__PURE__ */ G("<div><span> </span><strong> </strong><small> </small></div>"), hS = /* @__PURE__ */ G("<li class=\"svelte-1ull9g0\"> </li>"), gS = /* @__PURE__ */ G("<ul></ul>"), _S = /* @__PURE__ */ G("<p>None proposed.</p>"), vS = /* @__PURE__ */ G("<section><strong> </strong><!></section>"), yS = /* @__PURE__ */ G("<li><strong> </strong><span> </span><p> </p></li>"), bS = /* @__PURE__ */ G("<details class=\"custody-candidates\"><summary> </summary><ul></ul></details>"), xS = /* @__PURE__ */ G("<label><input type=\"checkbox\"/><span>I approve this exact advisory charter as the next epoch.</span></label> <div><button class=\"outline-button\">Keep current charter</button><button class=\"primary-button\"> </button></div>", 1), SS = /* @__PURE__ */ G("<button class=\"outline-button\">Close proposal and keep current charter</button>"), CS = /* @__PURE__ */ G("<div class=\"strategy-proposal\"><header><div><span> </span><h3> </h3></div> <strong> </strong></header> <div class=\"strategy-proposal-objective\"><span>PROPOSED EPOCH</span> <strong> </strong> <p> </p></div> <div class=\"strategy-proposal-weights\" aria-label=\"Proposed track weights\"></div> <div class=\"strategy-action-diff\"></div> <!> <div class=\"strategy-human-gate\"><div><span>HUMAN ACTIVATION GATE</span><strong> </strong><small> </small></div> <!></div></div>"), wS = /* @__PURE__ */ G("<div role=\"status\"> </div>"), TS = /* @__PURE__ */ G("<li><span> </span><div><strong> </strong><small> </small></div></li>"), ES = /* @__PURE__ */ G("<details class=\"strategy-history\"><summary>Charter history <strong> </strong></summary><ol></ol></details>"), DS = /* @__PURE__ */ G("<li class=\"svelte-1ull9g0\"><span class=\"svelte-1ull9g0\"> </span><div><strong> </strong><small> </small></div></li>"), OS = /* @__PURE__ */ G("<details class=\"strategy-history strategy-review-history svelte-1ull9g0\"><summary>Independent review history <strong> </strong></summary><ol></ol></details>"), kS = /* @__PURE__ */ G("<details id=\"strategy-workspace\" class=\"strategy-workspace\"><summary><span><small>STRATEGY WORKSPACE</small><strong> </strong></span> <span class=\"strategy-workspace-state\"> </span></summary> <div class=\"strategy-workspace-body\"><div class=\"strategy-workspace-boundary\"><strong>Independent governance lane</strong> <p>Epoch and idea-search reviews run in one dedicated read-only Sol lane. Each request binds its strategy slot and token cap, and cannot interrupt the regular coordinator, change campaign phase, dispatch workers, or activate its own proposal.</p></div> <!> <!> <!> <!></div></details>");
function AS(e, t) {
	bt(t, !1);
	...
	var T = ca(), E = R(T), D = (e) => {
		var t = kS(), n = L(t), r = L(n), i = z(L(r)), x = L(i);
		N(i), N(r);
		var T = z(r, 2), E = L(T, !0);
		N(T), N(n);
		var D = z(n, 2), O = z(L(D), 2), k = (e) => {
			var t = fS(), n = L(t), r = z(L(n), 2), i = L(r, !0);
			N(r);
			var a = z(r, 2), o = L(a, !0);
			N(a), N(n);
			var s = z(n, 2), c = z(L(s));
			...
			var t = pS(), n = z(L(t), 2), r = L(n), i = L(r, !0);
			N(r);
			var a = z(r), o = L(a, !0);
			N(a);
			var s = z(a), c = L(s);
			...
			var t = CS(), n = L(t), r = L(n), i = L(r), c = L(i);
			N(i);
			var m = z(i), h = L(m, !0);
			N(m), N(r);
			var g = z(r, 2), _ = L(g, !0);
...
Zi(["click"]), Ho();
var jS = /* @__PURE__ */ G("<span class=\"svelte-pcnttw\"> </span>"), MS = /* @__PURE__ */ G("<li class=\"svelte-pcnttw\"> </li>"), NS = /* @__PURE__ */ G("<section><header class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">WHAT HAPPENED</span><strong class=\"svelte-pcnttw\"> </strong></header> <p class=\"svelte-pcnttw\"> </p> <div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">RECOMMENDED NEXT</span><b class=\"svelte-pcnttw\"> </b></div> <small class=\"svelte-pcnttw\"> </small></section>"), PS = /* @__PURE__ */ G("<button class=\"primary-button compact svelte-pcnttw\"> </button>"), FS = /* @__PURE__ */ G("<button class=\"outline-button compact svelte-pcnttw\"> </button>"), IS = /* @__PURE__ */ G("<button class=\"outline-button compact svelte-pcnttw\" disabled=\"\">Contract reshape required</button>"), LS = /* @__PURE__ */ G("<button class=\"outline-button compact svelte-pcnttw\" disabled=\"\">Queued · custody slot busy</button>"), RS = /* @__PURE__ */ G("<code class=\"svelte-pcnttw\"> </code>"), zS = /* @__PURE__ */ G("<b class=\"svelte-pcnttw\"> </b><p class=\"svelte-pcnttw\"> </p>", 1), BS = /* @__PURE__ */ G("<div class=\"custody-receipt-review svelte-pcnttw\"><header class=\"svelte-pcnttw\"><div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">MEASURED RESULT</span><strong class=\"svelte-pcnttw\"> </strong></div><b class=\"svelte-pcnttw\"> </b></header> <div class=\"custody-receipt-metrics svelte-pcnttw\"><span class=\"svelte-pcnttw\"> </span><span class=\"svelte-pcnttw\"> </span><span class=\"svelte-pcnttw\"> </span><span class=\"svelte-pcnttw\"> </span></div> <!> <details class=\"svelte-pcnttw\"><summary class=\"svelte-pcnttw\">Inspect checks, worktree, and immutable bindings</summary><div class=\"svelte-pcnttw\"><b class=\"svelte-pcnttw\">Producer</b><code class=\"svelte-pcnttw\"> </code><b class=\"svelte-pcnttw\">Worktree</b><code class=\"svelte-pcnttw\"> </code><!></div></details> <footer class=\"svelte-pcnttw\"><button class=\"outline-button compact svelte-pcnttw\">Reject result</button><button class=\"primary-button svelte-pcnttw\"> </button></footer> <small class=\"svelte-pcnttw\">Landing rechecks the exact receipt and clean checkout, then cherry-picks only the frozen producer commit. It never pushes or promotes a claim.</small></div>"), VS = /* @__PURE__ */ G("<div><div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\"> </span> <strong class=\"svelte-pcnttw\"> </strong> <small class=\"svelte-pcnttw\"> </small></div> <!></div> <!>", 1), HS = /* @__PURE__ */ G("<button class=\"outline-button compact svelte-pcnttw\">Park</button> <button class=\"primary-button svelte-pcnttw\"> </button>", 1), US = /* @__PURE__ */ G("<span class=\"svelte-pcnttw\"> </span><button class=\"outline-button compact svelte-pcnttw\">Park</button>", 1), WS = /* @__PURE__ */ G("<span class=\"svelte-pcnttw\">Research continues independently while this isolated steward works.</span>"), GS = /* @__PURE__ */ G("<span class=\"svelte-pcnttw\">The measured receipt above has no landing authority until you accept it.</span>"), KS = /* @__PURE__ */ G("<div class=\"custody-footer-actions svelte-pcnttw\"><button class=\"primary-button svelte-pcnttw\"> </button></div>"), qS = /* @__PURE__ */ G("<button class=\"primary-button svelte-pcnttw\"> </button>"), JS = /* @__PURE__ */ G("<div class=\"custody-footer-actions svelte-pcnttw\"><!> <!></div>"), YS = /* @__PURE__ */ G("<div class=\"custody-footer-actions svelte-pcnttw\"><button class=\"primary-button svelte-pcnttw\">Park until macOS is available</button></div>"), XS = /* @__PURE__ */ G("<div class=\"custody-footer-actions svelte-pcnttw\"><button class=\"outline-button compact svelte-pcnttw\"> </button><button class=\"primary-button svelte-pcnttw\"> </button></div>"), ZS = /* @__PURE__ */ G("<div class=\"custody-footer-actions svelte-pcnttw\"><!></div>"), QS = /* @__PURE__ */ G("<span class=\"svelte-pcnttw\"> </span> <!>", 1), $S = /* @__PURE__ */ G("<span class=\"svelte-pcnttw\">Outside the active service queue.</span><button class=\"outline-button compact svelte-pcnttw\">Restore to inbox</button>", 1), eC = /* @__PURE__ */ G("<article><header class=\"svelte-pcnttw\"><div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\"> </span><strong class=\"svelte-pcnttw\"> </strong></div> <b> </b></header> <p class=\"svelte-pcnttw\"> </p> <div class=\"custody-item-facts svelte-pcnttw\"><span class=\"svelte-pcnttw\"> </span> <span class=\"svelte-pcnttw\"> </span> <span class=\"svelte-pcnttw\"> </span> <span class=\"svelte-pcnttw\"> </span> <!></div> <details class=\"custody-contract svelte-pcnttw\"><summary class=\"svelte-pcnttw\">Inspect acceptance contract <strong class=\"svelte-pcnttw\"> </strong></summary> <div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">ACCEPT WHEN</span><ul class=\"svelte-pcnttw\"></ul></div> <div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">ALLOWED PATHS</span><code class=\"svelte-pcnttw\"> </code></div> <div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">HARD STOP</span><p class=\"svelte-pcnttw\"> </p></div></details> <!> <!> <footer class=\"svelte-pcnttw\"><!></footer></article>"), tC = /* @__PURE__ */ G("<div class=\"custody-inbox svelte-pcnttw\"></div>"), nC = /* @__PURE__ */ G("<div class=\"custody-empty svelte-pcnttw\"><strong class=\"svelte-pcnttw\">No custody contracts are queued</strong><p class=\"svelte-pcnttw\">Future strategy reviews can stage bounded candidates here. Until then, the service has no authority and consumes no resources.</p></div>"), rC = /* @__PURE__ */ G("<li class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\"> </span><div class=\"svelte-pcnttw\"><strong class=\"svelte-pcnttw\"> </strong><small class=\"svelte-pcnttw\"> </small></div></li>"), iC = /* @__PURE__ */ G("<details class=\"custody-protocol-history svelte-pcnttw\"><summary class=\"svelte-pcnttw\">Custody lease and receipt history <strong> </strong></summary><ol class=\"svelte-pcnttw\"></ol></details>"), aC = /* @__PURE__ */ G("<p class=\"svelte-pcnttw\"> </p>"), oC = /* @__PURE__ */ G("<div class=\"custody-violations svelte-pcnttw\"><strong class=\"svelte-pcnttw\"> </strong><!></div>"), sC = /* @__PURE__ */ G("<div role=\"status\"> </div>"), cC = /* @__PURE__ */ G("<details id=\"custody-service\" class=\"custody-service svelte-pcnttw\"><summary class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\"><small class=\"svelte-pcnttw\">CUSTODY SERVICE</small><strong class=\"svelte-pcnttw\"> </strong></span> <span class=\"custody-summary-counts svelte-pcnttw\"><b class=\"svelte-pcnttw\"> </b><b class=\"svelte-pcnttw\"> </b><i class=\"svelte-pcnttw\">SEPARATE EXECUTOR</i></span></summary> <div class=\"custody-body svelte-pcnttw\"><div class=\"custody-boundary svelte-pcnttw\"><div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">ADAPTER</span><strong class=\"svelte-pcnttw\">Terra local steward</strong><small class=\"svelte-pcnttw\"> </small></div> <p class=\"svelte-pcnttw\">Terra may repair small mechanical or mathematical mistakes only inside the listed paths and acceptance checks. It cannot choose direction, spawn children, promote claims, merge, or push.</p> <div class=\"svelte-pcnttw\"><span class=\"svelte-pcnttw\">AUTOPILOT RULE</span><strong class=\"svelte-pcnttw\">Land verified custody</strong><small class=\"svelte-pcnttw\">active loop may dispatch · only exact landable receipts integrate</small></div></div> <!> <!> <!> <!></div></details>");
function lC(e, t) {
	bt(t, !1);
	...
	function p(e) {
		...
		return As(e) ? {
			...
			summary: "This steward stopped with zero changes because fixed App Server context consumed most of the old " + ks(e).toLocaleString() + "-token total-turn lease.",
	...
	var v = ca(), y = R(v), b = (e) => {
		...
		var O = z(w, 2), k = (e) => {
			...
			Y(t, 5, () => H(a), (e) => e.id, (e, t) => {
				let n = /* @__PURE__ */ Cn(() => (H(t), U(() => p(H(t))))), r = /* @__PURE__ */ Cn(() => (H(t), U(() => m(H(t))))), i = /* @__PURE__ */ Cn(() => (Si(Ns), H(t), U(() => Ns(H(t))))), a = /* @__PURE__ */ Cn(() => (Si(Ms), H(t), H(o), U(() => Ms(H(t), String(H(o)?.loop?.error || ""))))), l = /* @__PURE__ */ Cn(() => (H(o), H(t), U(() => Number(H(o)?.resources?.ledger?.remainingBeforeCommitments || 0) >= Number(H(t).tokenCap || 0))));
				var u = eC();
				let f;
				...
				J(ie, (e) => {
					H(t), U(() => !H(t).dependenciesSatisfied) && e(ae);
				}), N(O);
				var oe = z(O, 2), se = L(oe), ce = z(L(se)), le = L(ce, !0);
				N(ce), N(se);
				var ue = z(se, 2), de = z(L(ue));
				Y(de, 5, () => (H(t), U(() => H(t).acceptance.acceptanceCriteria)), _a, (e, t) => {
					var n = MS(), r = L(n, !0);
					N(n), V(() => q(r, H(t))), K(e, n);
				}), N(de), N(ue);
				var fe = z(ue, 2), pe = z(L(fe)), me = L(pe, !0);
				N(pe), N(fe);
				var he = z(fe, 2), ge = z(L(he)), _e = L(ge, !0);
				N(ge), N(he), N(oe);
				var ve = z(oe, 2), ye = (e) => {
					var t = NS(), r = L(t), i = z(L(r)), a = L(i, !0);
					N(i), N(r);
					var o = z(r, 2), s = L(o, !0);
					N(o);
				...
				}, be = /* @__PURE__ */ P(() => (H(t), U(() => ["blocked", "failed"].includes(H(t).status))));
				J(ve, (e) => {
					H(be) && e(ye);
				});
				var xe = z(ve, 2), Se = (e) => {
					...
					var O = z(o, 2), k = (e) => {
						var n = BS(), r = L(n), i = L(r), a = z(L(i)), o = L(a, !0);
						N(a), N(i);
						var s = z(i), l = L(s, !0);
						N(s), N(r);
				...
				var we = z(xe, 2), Te = L(we), Ee = (e) => {
					var n = HS(), r = R(n), i = z(r, 2), a = L(i, !0);
					N(i), V((e, n) => {
				...
				}, je = /* @__PURE__ */ P(() => (H(t), U(() => ["blocked", "failed"].includes(H(t).status)))), Me = (e) => {
					var n = $S(), r = z(R(n));
					V((e) => r.disabled = e, [() => (H(c), U(() => !!H(c)))]), W("click", r, () => _(H(t), "restore")), K(e, n);
				};
				J(Te, (e) => {
					H(t), U(() => H(t).status === "proposed") ? e(Ee) : (H(t), U(() => H(t).status === "ready") ? e(De, 1) : (H(t), U(() => H(t).status === "assigned") ? e(Oe, 2) : (H(t), U(() => H(t).status === "verifying") ? e(ke, 3) : H(je) ? e(Ae, 4) : (H(t), U(() => H(t).status === "parked") && e(Me, 5)))));
				}), N(we), N(u), V((e, n) => {
					f = X(u, 1, "svelte-pcnttw", null, f, {
						blocking: H(t).blocksResearch,
						parked: H(t).status === "parked"
					}), q(x, `${H(t), U(() => H(t).urgency) ?? ""} · ${H(t), U(() => H(t).capability) ?? ""} · ${H(t), U(() => H(t).strategicTrack) ?? ""}`), q(C, (H(t), U(() => H(t).task))), X(w, 1, (H(t), U(() => `custody-status-${H(t).status}`)), "svelte-pcnttw"), q(T, e), q(D, (H(t), U(() => H(t).reason))), q(A, (H(t), U(() => H(t).blocksResearch ? "BLOCKS RESEARCH" : "NON-BLOCKING"))), q(ee, `repair generation ${H(t), U(() => H(t).repairGeneration) ?? ""}/${H(s), U(() => H(s).policy.maxAutomaticRepairGeneration) ?? ""}`), q(te, `${H(t), U(() => H(t).effortClass) ?? ""} effort`), q(re, (H(t), U(() => H(t).contractComplete ? "contract complete" : "contract incomplete"))), q(le, (H(t), U(() => H(t).acceptance.receiptType || "receipt missing"))), q(me, n), q(_e, (H(t), U(() => H(t).acceptance.stopCondition || "No stop condition declared")));
		...
		var j = z(O, 2), ee = (e) => {
			var t = iC(), n = L(t), r = z(L(n)), i = L(r);
			N(r), N(n);
			var a = z(n);
			Y(a, 5, () => (H(s), U(() => H(s).protocol.leases)), _a, (e, t) => {
				var n = rC(), r = L(n), i = L(r, !0);
				N(r);
				var a = z(r), o = L(a), s = L(o, !0);
				N(o);
				var c = z(o), l = L(c);
		...
		J(M, (e) => {
			H(s), U(() => H(s).violations?.length) && e(te);
		});
		var ne = z(M, 2), re = (e) => {
			var t = sC(), n = L(t, !0);
			N(t), V(() => {
...
function mC(e, t) {
	...
	var v = z(o, 2), y = L(v), b = (e) => {
		...
		uS(S, {});
		var C = z(S, 2);
		AS(C, {}), Rc(z(C, 2), {}), N(b), N(y);
		var w = z(y, 2), T = z(L(w), 2), E = L(T);
		ll(E, {}), $c(z(E, 2), {}), N(T), N(w), N(c), K(e, t);
	};
	J(y, (e) => {
...
Zi(["click"]), la(mC, { target: document.querySelector("#app") });
//#endregion
