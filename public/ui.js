...
function al(e, t) {
	...
	var oe = il(), se = B(oe), ce = (e) => {
		...
		var ee = z(N), ne = z(ee), ie = (e) => {
			...
			var p = V(s, 2);
			hc(V(z(p)), {}), F(p), U(() => {
				Y(r, W(d) ? "The symmetry paper checkpoint" : "Your saved review plan"), Y(a, (W(o), G(() => W(o).id === "cfg23" ? "The current result narrows real collineation symmetry to 1, C₂ or V₄. Full asymmetry remains open." : "Explore the saved results and review questions while execution setup is pending.")));
			}), K("click", u, () => W(b).open()), K("click", f, () => {
