<script lang="ts">
  ...
  $: statusLabel = scheduleGate && schedule?.status === "proposed" ? "CONFIRM WAVE"
  ...
  $: statusClass = scheduleGate && schedule?.status === "proposed" ? "attention"
