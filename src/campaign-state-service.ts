...
const TRANSITIONS: Record<CampaignWorkflowPhase, ReadonlySet<CampaignWorkflowPhase>> = {
  ...
  RESEARCH_READY: new Set(["RESEARCH_READY", "RESEARCH_REVIEW", "RESEARCH_RUNNING", "RESEARCH_INTAKE", "BLOCKED"]),
  RESEARCH_RUNNING: new Set(["RESEARCH_RUNNING", "RESEARCH_INTAKE", "BLOCKED"]),
  RESEARCH_INTAKE: new Set(["RESEARCH_INTAKE", "RESEARCH_READY", "SYNTHESIZING", "BLOCKED"]),
